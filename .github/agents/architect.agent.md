...
# Workflow
1. Read `docs/agentic-development/requirements.md` and `docs/agentic-development/acceptance_criteria.md`.
2. Generate `docs/agentic-development/architecture.md`.
