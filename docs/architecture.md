...
### 4.9 Scenes UI and composite three.js (**REQ-015**, **REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-021**, **REQ-022**, **REQ-023**, **REQ-027**)
...
### 4.13 Python routine editor, visual debug, on-page reference, and bottom API catalog (**REQ-022**–**REQ-027**, **REQ-023**)
...
### 8.18 Python routine page: visual debug sync and scene resets (**REQ-027**, **§4.13**)
...
sequenceDiagram
  ...
  loop Each successful worker PATCH for that scene
    ...
    Page->>Canvas: merge state (REQ-012 timeliness)
  end
...
| REQ-027 | §3.15 (`PATCH …/lights/state/scene` for reset), §4.7, §4.9, §4.13, §8.18 |

---

**Next step:** After **material** **code** **or** **requirement** **changes**, invoke **`@implementor`** **then** **`@verifier`** **to** **keep** **tests**, **`docs/traceability_matrix.md`**, **and** **this** **document** **aligned**. **REQ-022** **editor** **surface** **is** **implemented** **with** **`EditorView`**, **`codemirror`** **`basicSetup`**, **and** **`@codemirror/*`** **per** **§3.17** **and** **§4.13** **above**. **REQ-023** **is** **satisfied** **by** **the** **§4.12** **create** **flow** **(single** **`type`** **dropdown** **including** **Python**)** **without** **a** **redundant** **primary** **Python-only** **create** **button**. **REQ-024**–**REQ-027** **are** **specified** **in** **§3.15**, **§3.17**, **§4.13**, **and** **§8.18** **as** **above**.
