...
**Ordering:** Register **API** routes **before** static/`NotFound` handling so `/api/v1` is never swallowed by UI fallback. Register **literal** **path** **segments** **`routines`**, **`start`**, **`stop`**, **`factory-reset`**, **`reset`**, **`state`**, **`batch`**, **`system`** **before** **any** **`{id}`** **pattern** **that** **could** **swallow** **them**. Register **`PATCH /api/v1/routines/{id}`** **so** **`routines`** **is** **not** **matched** **as** **an** **id** **elsewhere**.
...
### 4.9 Scenes UI and composite three.js (**REQ-015**, **REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-021**, **REQ-022**, **REQ-023**, **REQ-027**, **REQ-028**)
...
**Next step:** After **material** **code** **or** **requirement** **changes**, invoke **`@implementor`** **then** **`@verifier`** **to** **keep** **tests**, **`docs/traceability_matrix.md`**, **and** **this** **document** **aligned**. **REQ-022** **editor** **surface** **is** **implemented** **with** **`EditorView`**, **`codemirror`** **`basicSetup`**, **and** **`@codemirror/*`** **per** **§3.17** **and** **§4.13** **above**. **REQ-023** **is** **satisfied** **by** **the** **§4.12** **create** **flow** **(single** **`type`** **dropdown** **including** **Python**)** **without** **a** **redundant** **primary** **Python-only** **create** **button**. **REQ-024**–**REQ-027** **are** **specified** **in** **§3.15**, **§3.17**, **§4.13**, **and** **§8.18** **as** **above**. **REQ-028** **is** **specified** **in** **§4.7**, **§4.9**, **§4.13**, **§6.5**, **and** **§8.5**/**§8.7** **above**.
