...
### 4.9 Scenes UI and composite three.js (**REQ-015**, **REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-021**, **REQ-022**, **REQ-023**)
...
**Next step:** After **material** **code** **or** **requirement** **changes**, invoke **`@implementor`** **then** **`@verifier`** **to** **keep** **tests**, **`docs/traceability_matrix.md`**, **and** **this** **document** **aligned**. **REQ-022** **editor** **surface** **is** **implemented** **with** **`EditorView`**, **`codemirror`** **`basicSetup`**, **and** **`@codemirror/*`** **per** **§3.17** **and** **§4.13** **above**. **REQ-023** **is** **satisfied** **by** **the** **§4.12** **create** **flow** **(single** **`type`** **dropdown** **including** **Python**)** **without** **a** **redundant** **primary** **Python-only** **create** **button**.
