...
| REQ-024 | **§4.13** (**`<section id="python-scene-api-catalog">`** **immediately** **below** **editor** **—** **complete** **manifest** **from** **§3.17** **including** **REQ-030** **`scene.random_hex_colour`**, **`scene.max_x`/`max_y`/`max_z`**, **and** **REQ-032** **sample** **entries**; **picker** **per** **entry**; **detail** **+** **commented** **sample**; **insert** **at** **caret** **or** **EOF**). |
...
| REQ-032 | **§3.17.1** **(**geometry** **+** **timing** **for** **the** **two** **samples**)** **,** **§4.13** **(**`PYTHON_SAMPLE_GROWING_SPHERE_SOURCE`**, **`PYTHON_SAMPLE_SWEEPING_CUBOID_SOURCE`**, **REQ-024** **catalog** **entries** **+** **insert** **snippets**)** **,** **`web/lib/pythonRoutineSamples.ts`** **(**single** **source** **of** **truth** **for** **sample** **bodies**)** **;** **REQ-025** **default** **template** **remains** **the** **minimal** **sphere** **demo** **unless** **explicitly** **replaced** **later**. |
...
### 3.17.1 REQ-032 novice sample routines — geometry, timing, and delivery

**Purpose:** **Two** **complete** **sample** **`python_source`** **bodies** **(**growing** **sphere** **+** **sweeping** **cuboid**)** **that** **use** **only** **the** **§3.17** **`scene`** **surface** **(**plus** **`scene.random_hex_colour()`** **per** **REQ-030**)** **,** **heavy** **with** **short** **`#`** **comments** **for** **novices** **(**REQ-024** **sample** **style**)**.

**Single source of truth (implementor):** **`web/lib/pythonRoutineSamples.ts`** **exports** **`PYTHON_SAMPLE_GROWING_SPHERE_SOURCE`** **and** **`PYTHON_SAMPLE_SWEEPING_CUBOID_SOURCE`** **(**each** **a** **single** **string** **—** **the** **exact** **text** **saved** **into** **`routines.python_source`** **when** **the** **user** **chooses** **“Load** **sample”** **or** **duplicates** **a** **seed** **definition**)**. **§4.13** **REQ-024** **catalog** **MUST** **include** **two** **entries** **(**titles** **e.g.** **“Sample:** **growing** **sphere”**, **“Sample:** **sweeping** **cuboid”**)** **whose** **commented** **snippets** **and** **Insert** **behavior** **pull** **from** **the** **same** **strings** **(**no** **drift** **between** **catalog** **and** **file**)**.

**Relation to REQ-025:** **The** **default** **new-routine** **template** **remains** **`PYTHON_ROUTINE_DEFAULT_SOURCE`** **(**minimal** **sphere** **colour** **demo**)** **unchanged** **by** **REQ-032** **unless** **a** **later** **product** **decision** **replaces** **that** **template** **with** **one** **of** **these** **samples**.

**Scene axes** **(**§3.15** **+** **REQ-026**)** **for** **sample** **math:** **`origin`** **is** **`(0,0,0)`** **;** **`size.width`** **→** **+X** **extent** **(**`scene.width`**)** **;** **`size.height`** **→** **+Y** **(**up** **in** **default** **`SceneLightsCanvas`** **)** **(**`scene.height`**)** **;** **`size.depth`** **→** **+Z** **(**`scene.depth`**)** **. **`max`** **from** **`GET …/dimensions`** **is** **`(max.x, max.y, max.z)`** **—** **the** **inclusive** **upper** **corner** **of** **the** **query** **AABB** **(**§3.15**)** **so** **every** **light** **satisfies** **`0 ≤ sx ≤ max.x`** **etc.**

**Time base:** **Use** **`import time`** **and** **`time.monotonic()`** **(**not** **`time.time()`**)** **to** **measure** **each** **10** **s** **cycle** **and** **each** **frame** **within** **the** **cycle** **(**monotonic** **avoids** **jumps** **if** **the** **OS** **clock** **adjusts**)**.

**Growing-sphere sample** **(**loop** **per** **REQ-032** **business** **rule** **2**)** **:**
...
**Sweeping-cuboid sample** **(**loop** **per** **REQ-032** **business** **rule** **3**)** **:**
...
6. **Same** **inner** **`step = 0.05`** **s** **cadence** **as** **the** **sphere** **sample** **unless** **profiling** **on** **Pi** **motivates** **a** **documented** **larger** **step** **(**trade-off:** **smoothness** **vs** **HTTP** **load** **—** **REQ-029** **§3.18**)**.

**Performance note:** **At** **~20** **sphere** **updates/s** **for** **10** **s** **plus** **up** **to** **~20** **cuboid** **queries** **+** **1** **bulk** **patch** **+** **variable** **batch** **offs/s** **,** **the** **browser** **should** **reuse** **the** **same** **`fetch`** **connection** **pool** **(**default** **)** **and** **rely** **on** **§3.19** **no-op** **elision** **when** **state** **is** **unchanged** **(**optional** **worker-side** **cache** **§3.19** **—** **document** **if** **enabled**)**.
...
- **Novice** **samples** **(REQ-032):** **Ship** **`PYTHON_SAMPLE_GROWING_SPHERE_SOURCE`** **and** **`PYTHON_SAMPLE_SWEEPING_CUBOID_SOURCE`** **from** **`web/lib/pythonRoutineSamples.ts`** **(**§3.17.1** **for** **geometry,** **timing,** **and** **loop** **structure**)** **. **Expose** **them** **via** **(a)** **two** **REQ-024** **catalog** **entries** **with** **Insert** **inserting** **the** **full** **routine** **body** **and** **(b)** **optional** **toolbar** **actions** **e.g.** **“Load** **growing** **sphere** **sample”** **/** **“Load** **sweeping** **cuboid** **sample”** **that** **replace** **the** **editor** **buffer** **(**after** **confirm** **if** **the** **buffer** **is** **dirty**)** **—** **implementor** **chooses** **minimal** **set** **that** **still** **meets** **acceptance** **(**REQ-032** **requires** **at** **least** **two** **complete** **discoverable** **samples**)** **. **Do** **not** **duplicate** **source** **strings** **outside** **`pythonRoutineSamples.ts`** **(**single** **export** **feeds** **catalog** **+** **editor** **)** **.**
...
| REQ-022 | §1, §3.2, §3.15, §3.16, §3.17, §3.17.1 (REQ-032 uses same `scene` shim), §4.9, §4.11, §4.12, §4.13, §6.2, §7, §8.17 |
| REQ-023 | §1, §3.2 (`POST /routines` note), §3.16 (UI support), §4.9, §4.11 (nav: no Python-only item), §4.12, §4.13 |
| REQ-024 | §4.13 (`#python-scene-api-catalog` below editor; picker + commented samples + insert; manifest sync with §3.17 incl. REQ-030, `scene.max_*`, REQ-032 sample rows) |
