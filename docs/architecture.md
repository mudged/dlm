...
| REQ-017 | **`POST /api/v1/system/factory-reset`** (**§3.2**, **§3.14**); **`store.FactoryReset`** **transaction** **deletes** **`routine_runs`** **+** **`routines`** **before** **scenes**/**models** **then** **`SeedDefaultSamples`** **+** **`SeedDefaultPythonRoutines`** (**§3.8.1**); **Options** **route** **§4.10** **+** **modal** **before** **POST**; **post-success** **navigate** **`/models`** **+** **success** **message** (**architectural** **default** **for** **REQ-017** **open** **question**). |
...
| REQ-021 | **§3.2**, **§3.14**, **§3.15**, **§3.16**, **§3.17**, **§4.9**, **§4.11**, **§4.12**, **§8.16**/**§8.17**: **Python-only** **routine** **definitions** (**`python_scene_script`** **only** **—** **§3.16**); **scene-scoped** **start**/**stop**; **all** **automation** **via** **browser** **Pyodide** **loop** **(**§3.17**)** **calling** **only** **§3.15** **`…/lights/state/*`** **through** **the** **`scene`** **shim** (**not** **`/models/.../lights`** **for** **routine** **effects**); **no** **in-process** **Go** **routine** **ticker**; **one** **active** **run** **per** **scene**; **409** **on** **delete**/**PATCH** **while** **active**. |
...
| REQ-023 | **§4.12** (**Python-only** **create** **—** **no** **non-Python** **routine** **kind** **in** **UI**; **optional** **omit** **redundant** **`type`** **control** **or** **single** **fixed** **label**), **§4.13** (**editor** **routes**), **§4.9**, **§4.11**; **`POST /api/v1/routines`** **accepts** **only** **`python_scene_script`** **for** **new** **definitions** **(**§3.16**)**. |
...
| REQ-031 | **§3.9**, **§3.10**, **§3.15** **(**bulk** **no-op** **short-circuit**)**, **§3.16**, **§3.18**, **§3.19**, **§4.7**, **§4.9**, **§4.13**, **§8.7**, **§8.8**, **§8.20** **(**equivalence** **before** **visualization** **and** **persistence**; **future** **WLED** **hook** **documented** **in** **§3.19**)**. |
...
| API | `GET /api/v1/routines` | List routine definitions (**id**, **name**, **description**, **`type`**, **`python_source`**, **created_at**). **All** **supported** **definitions** **are** **`python_scene_script`** **with** **`python_source`** **(**legacy** **`type`** **values** **may** **appear** **until** **migration**)**. **REQ-021**, **REQ-022** |
| API | `GET /api/v1/routines/{id}` | **200** **one** **definition** **(same** **shape** **as** **list** **row**)**. **404** **if** **unknown**. **REQ-022** |
| API | `POST /api/v1/routines` | Create definition: **`{ "name", "description", "python_source"?, "type"? }`** — **`name`** **non-empty** **trimmed**; **`description`** **string** **(may** **be** **`""`)**; **`python_source`** **string** **(**may** **be** **`""`** **—** **client** **may** **substitute** **`PYTHON_ROUTINE_DEFAULT_SOURCE`** **before** **save** **per** **§4.13**)**. **`type`** **if** **present** **MUST** **be** **`python_scene_script`** **;** **if** **omitted**, **server** **defaults** **to** **`python_scene_script`**. **Unknown** **`type`** → **400**. **201** + full row. **REQ-021**, **REQ-022**, **REQ-023** |
| API | `PATCH /api/v1/routines/{id}` | **JSON** **`{ "name"?, "description"?, "python_source"? }`** **with** **≥ 1** **field**. **200** **updated** **row**. **404** **if** **missing**. **409** **`routine_not_editable`** **only** **if** **legacy** **row** **`type`** **≠** **`python_scene_script`** **(**should** **not** **occur** **after** **migration**)**. **409** **`routine_run_active`** **if** **a** **`running`** **run** **exists** **for** **this** **`routine_id`**. |
...
### 3.16 Scene routines — persistence and HTTP (**REQ-021**, **REQ-022**)

**Architectural resolution (Python-only):**

- **Creatable** **definitions** **use** **`type = 'python_scene_script'`** **only.** **`POST /api/v1/routines`** **MUST** **reject** **any** **other** **`type`** **with** **`400`** **(**or** **treat** **omitted** **`type`** **as** **`python_scene_script`** **if** **the** **client** **sends** **only** **`name`**/**`description`**/**`python_source`** **—** **document** **the** **chosen** **JSON** **shape**)**.
- **Legacy** **`random_colour_cycle_all`** **rows** **(**pre-requirements** **change**)** **SHOULD** **be** **removed** **or** **converted** **to** **`python_scene_script`** **with** **the** **§3.17.1** **third-sample** **source** **in** **a** **one-time** **migration** **or** **at** **next** **factory** **reset** **(**implementor** **documents** **policy**)**.
- **No** **`time.Ticker`** **or** **in-process** **Go** **routine** **scheduler:** **all** **light** **mutations** **from** **automation** **run** **in** **the** **browser** **Pyodide** **loop** **(**§3.17**)**. **The** **former** **“random** **colour** **cycle** **all** **lights”** **effect** **is** **a** **seeded** **Python** **script** **(**§3.8.1**, **§3.17.1**)** **—** **~1** **s** **cadence** **is** **implemented** **inside** **that** **script** **(**`asyncio.sleep`** **or** **elapsed** **time** **per** **iteration**)** **and** **documented** **in** **`README.md`** **with** **the** **default** **iteration** **gap** **(**§3.17**)**.
- **Concurrency:** **At** **most** **one** **`routine_runs`** **row** **with** **`status = 'running'`** **per** **`scene_id`**. **Starting** **a** **second** **routine** **on** **the** **same** **scene** **→** **`409`** **`scene_routine_conflict`** **with** **actionable** **`details`** **(**existing** **`run_id`**, **`routine_id`)**.
- **Delete** **/** **PATCH** **while** **running:** **`DELETE`** **and** **`PATCH /api/v1/routines/{id}`** **use** **`409`** **`routine_run_active`** **when** **any** **`routine_runs`** **row** **for** **that** **`routine_id`** **has** **`status = 'running'`** **(**§3.2**)**.

**Tables (logical, SQLite):**

| Table | Columns | Notes |
|-------|---------|--------|
| **`routines`** | `id` (TEXT **UUID** PK), `name` (TEXT **NOT NULL**), `description` (TEXT **NOT NULL**, **allow** **`""`**), `type` (TEXT **NOT NULL** — **`python_scene_script`** **for** **all** **new** **rows**), `python_source` (TEXT **NOT NULL**), `created_at` (TEXT **RFC3339** UTC) | **Legacy** **`type`** **values** **may** **exist** **until** **migration** **;** **new** **inserts** **and** **seeds** **use** **`python_scene_script`** **only.** |
| **`routine_runs`** | `id` (TEXT **UUID** PK), `routine_id` (TEXT **FK** → **`routines.id`** **ON DELETE RESTRICT**), `scene_id` (TEXT **FK** → **`scenes.id`** **ON DELETE CASCADE**), `status` (TEXT **NOT NULL**: **`running`** \| **`stopped`**), `started_at`, `stopped_at` (TEXT **RFC3339** **nullable** **for** **`stopped_at`**) | **At** **most** **one** **`running`** **row** **per** **`scene_id`** **(**store** **transaction** **+** **partial** **UNIQUE** **where** **supported**)**. **Scene** **delete** **cascades** **runs** **away.** |

**Execution model:** **`POST …/start`** **inserts** **`routine_runs`** **`running`** **and** **returns** **`201`**. **The** **Go** **process** **does** **not** **mutate** **lights** **for** **routines** **(**no** **mandatory** **initial** **`PATCH`** **on** **start** **)** **—** **the** **client** **(**§3.17**, **§4.9**, **§4.13**)** **loads** **`python_source`**, **starts** **the** **worker** **loop**, **and** **issues** **`fetch`** **calls** **to** **§3.15** **only**. **If** **no** **browser** **runs** **the** **worker**, **the** **row** **may** **stay** **`running`** **without** **visible** **effects** **(**document** **in** **§4.13** **help** **copy**)**.

**REQ-021** **(**scene** **API** **for** **automation**)**:** **Routine** **effects** **MUST** **not** **use** **`PATCH /api/v1/models/{id}/lights/…`**. **Python** **code** **MUST** **use** **only** **the** **`scene`** **shim** **→** **`PATCH /api/v1/scenes/{id}/lights/state/*`** **(**§3.15**)**.

**Start/stop semantics:**

- **`POST …/start`:** **Validate** **scene** **+** **routine** **exist**; **`routines.type`** **MUST** **be** **`python_scene_script`** **(**else** **`400`** **`validation_failed`** **or** **migration** **path** **above**)**. **If** **a** **`running`** **row** **already** **exists** **for** **`(scene_id, routine_id)`:** **`200`** **idempotent** **`{ "run_id", "status": "running" }`**. **Else** **if** **another** **`running`** **row** **exists** **for** **`scene_id`:** **`409`**. **Else** **`INSERT`** **`running`** **;** **`201`** **after** **`COMMIT`**.
- **`POST …/stop`:** **Set** **`status=stopped`**, **`stopped_at=now`**. **Idempotent** **if** **already** **stopped**.

**Scene deletion:** **`ON DELETE CASCADE`** **on** **`routine_runs.scene_id`**.

**UI support:** **§4.12** **(**Python-only** **create** **—** **REQ-023**)**; **§4.13** **(**editor** **+** **REQ-024**)**; **§4.9** **(**start**/**stop** **selected** **routine** **on** **scene**)**.

**Volumetric** **and** **other** **effects:** **Authored** **in** **Python** **using** **`scene.set_lights_in_*`**, **`scene.update_lights_batch`**, **etc.** **(**§3.17**)** **—** **no** **separate** **server** **routine** **engine**.
...
- **Routines on scene detail (REQ-021, REQ-022, REQ-023):** **Panel** **or** **toolbar** **with** **`GET /api/v1/routines`** **(**`<select>`** **or** **list** **of** **definitions** **—** **all** **are** **Python** **routines**)**; **`POST …/start`** **and** **`POST …/stop`** **with** **Font Awesome** **icons**. **After** **`GET …/routines/runs`**, **show** **active** **run** **(**name** **+** **Stop**)** **or** **“No** **routine** **running”**. **On** **`409`** **`scene_routine_conflict`**, **surface** **`error.message`**. **Optional** **“Edit** **routine”** **→** **`/routines/python/[routineId]`** **(§4.13)** **—** **must** **not** **replace** **primary** **create** **via** **`/routines/new`** **(§4.12)**.
...
- **Live updates while a routine runs (REQ-012, REQ-029, REQ-031):** **While** **`/scenes/[id]`** **is** **mounted** **and** **`GET …/routines/runs`** **shows** **`running`**, **poll** **`GET /api/v1/scenes/{id}`** **every** **`≤ 2 s`** **(fast** **enough** **for** **typical** **Python** **routine** **iteration** **and** **~1** **s** **effects**)** **and** **merge** **`items[].lights`** **into** **`SceneLightsCanvas`**. **Apply** **§3.19** **equivalence** **so** **unchanged** **poll** **payloads** **skip** **redundant** **canvas** **work**. **The** **Pyodide** **worker** **(§3.17)** **drives** **writes** **via** **`fetch`****;** **polling** **merges** **authoritative** **server** **state** **(**other** **tabs**, **scene** **page** **without** **editor**)**. **Stop** **polling** **when** **no** **run** **is** **active** **or** **on** **unmount**. **High-frequency** **external** **writers** **SHOULD** **use** **§3.15** **bulk**/**batch** **(**§3.18**)**; **optional** **SSE** **(**§3.18**/**§8.19**)** **reduces** **polling** **when** **implemented**.
...
- **Routes:** **`/routines`** **(App Router)** — **list** **`GET /api/v1/routines`** **(**name**, **description** **truncated**, **created** **date**; **`type`** **column** **may** **show** **`Python`** **or** **be** **omitted** **if** **redundant**)**. **`/routines/new`** **hosts** **the** **create** **form** **(**REQ-023** **—** **Python-only** **;** **no** **`random_colour_cycle_all`** **or** **other** **non-Python** **kind** **selector**)**.
- **Create (REQ-021 + REQ-023):** **Form** **fields:** **`name`** **(required)**, **`description`** **(optional** **empty** **string)**, **and** **either** **inline** **`python_source`** **or** **client** **substitutes** **`PYTHON_ROUTINE_DEFAULT_SOURCE`** **before** **`POST`** **(**§4.13**)**. **`POST /api/v1/routines`** **with** **`type`** **omitted** **or** **`python_scene_script`** **only** **(**§3.2**)**. **After** **`201`**, **`router.push(`/routines/python/${id}`)`** **to** **§4.13**. **Optional** **read-only** **“Kind:** **Python”** **label** **MAY** **replace** **a** **`type`** **`<select>`** **when** **only** **one** **kind** **exists** **(**REQ-023** **rule** **2**)**. **Do** **not** **add** **a** **second** **primary** **shell** **button** **whose** **only** **purpose** **is** **“new** **Python** **routine”** **when** **that** **duplicates** **“New** **routine”** **(**REQ-023** **rule** **3**)**.
...
- **Rows:** **Per-row** **“Edit”** **or** **row** **click** **→** **`/routines/python/[id]`** **(§4.13)**. **Duplicate** **`POST /api/v1/routines`** **with** **copied** **`name`** **(suffix** **“(copy)”)**, **`description`**, **`python_source`**, **`type`** **`python_scene_script`**.
...
flowchart LR
  subgraph UI["Next.js /routines/new"]
    A["New routine"] --> B["Name + description + default template source"]
    B --> C["POST /api/v1/routines python_scene_script"]
    C --> D["Navigate /routines/python/id"]
  end
...
- **Scene** **routines** **(REQ-021):** **No** **in-process** **Go** **`time.Ticker`** **for** **routines** **(**§3.16**)** **—** **all** **automation** **runs** **in** **the** **browser** **Pyodide** **worker** **(**§3.17**)**.
...
sequenceDiagram
  ...
  alt success
    ...
    B-->>User: Model list shows three samples; routine list shows three default Python samples
  else failure
    G-->>P: 500 JSON error
    P-->>B: 500
...
| REQ-021 | §1, §3.2, §3.8.1, §3.14, §3.15, §3.16, §3.17, §4.9, §4.11, §4.12, §7, §8.16, §8.17 |
| REQ-022 | §1, §3.2, §3.15, §3.16, §3.17, §3.17.1 (REQ-032 uses same `scene` shim), §4.9, §4.11, §4.12, §4.13, §6.2, §7, §8.16, §8.17 |
| REQ-023 | §1, §3.2 (`POST /routines` Python-only), §3.16 (UI support), §4.9, §4.11, §4.12, §4.13 |
...
| REQ-031 | §3.9, §3.10 (batch note), §3.15 (bulk semantics), §3.16 (`routine_runs` persistence), §3.18, §3.19, §4.7, §4.9, §4.13, §8.7, §8.8, §8.20 |
...
**Next step:** After **material** **code** **or** **requirement** **changes**, invoke **`@implementor`** **then** **`@verifier`** **to** **keep** **tests**, **`docs/traceability_matrix.md`**, **and** **this** **document** **aligned**. **REQ-022** **editor** **surface** **uses** **`EditorView`**, **`codemirror`** **`basicSetup`**, **and** **`@codemirror/*`** **per** **§3.17** **and** **§4.13**, **with** **novice** **instructional** **copy** **on** **that** **page**. **REQ-023** **is** **satisfied** **by** **the** **§4.12** **create** **flow** **(**Python-only** **definitions** **—** **optional** **fixed** **`type`** **label** **or** **omit** **`type`** **on** **`POST`** **per** **§3.16**)** **without** **a** **non-Python** **routine** **kind** **in** **the** **UI**. **REQ-024** **adds** **the** **interactive** **API** **reference** **below** **the** **editor** **(**picker**, **commented** **samples**, **insert** **at** **caret**/**EOF**)** **in** **§4.13** **(**rule** **7** **:** **full** **default** **scripts** **also** **via** **§3.8.1** **seed**)**. **REQ-027** **unifies** **run** **controls** **and** **`SceneLightsCanvas`** **under** **one** **scene** **selector** **(§4.13**, **§8.18**)**. **REQ-028** **is** **specified** **in** **§4.7**, **§4.9**, **§4.13**, **§6.5**, **and** **§8.5**/**§8.7** **above**. **REQ-029** **is** **specified** **in** **§3.18**, **with** **cross-references** **in** **§4.3**, **§4.7**, **§4.9**, **and** **§8.19**. **REQ-030** **adds** **`scene.random_hex_colour()`** **(**§3.17**, **§4.13** **manifest** **+** **template** **preference**, **worker** **implementation**)**. **REQ-031** **adds** **equivalence-based** **elision** **for** **persistence** **and** **three.js** **(**§3.19**)** **plus** **a** **documented** **hook** **for** **future** **WLED-class** **physical** **sync** **(**no** **device** **code** **in** **this** **requirement**)**. **REQ-032** **seeds** **three** **default** **Python** **sample** **routines** **(**§3.8.1**, **§3.17.1**, **`web/lib/pythonRoutineSamples.ts`**, **optional** **UI** **+** **§4.13**)** **without** **replacing** **REQ-025** **by** **default**.
