...
| REQ-022 | **§3.2**, **§3.15**, **§3.16** (**schema** **+** **start/stop** **shared** **with** **REQ-021**), **§3.17**, **§4.9** (**link** **to** **editor**), **§4.11** (**nav**), **§4.12** (**list** **entry**), **§4.13**, **§6.2** (**bundle** **size** **note**), **§7**, **§8.17** (**+** **REQ-024**–**REQ-027** **in** **§4.13**/**§8.18**): **`python_scene_script`** **+** **`python_source`**; **PATCH** **routine**; **CodeMirror** **6** **(mandatory)** **for** **browser** **Python** **editing** **—** **`@codemirror/view`** **`EditorView`** **+** **npm** **`codemirror`** **`basicSetup`** **+** **`@codemirror/*`** **extensions** **(see** **§4.13)**; **Pyodide** **worker** **`scene`** **API** **→** **`fetch`** **§3.15**; **cooperative** **stop** **+** **`worker.terminate()`** **after** **bounded** **wait**. |
...
| REQ-024 | **§4.13** (**bottom** **`#python-scene-api-catalog`** **—** **complete** **manifest** **of** **`scene`** **API** **with** **description** **+** **snippet** **per** **row**). |
| REQ-025 | **§4.13** (**`PYTHON_ROUTINE_DEFAULT_SOURCE`** **in** **`web/`** **—** **applied** **when** **creating** **`python_scene_script`** **with** **empty** **`python_source`** **and** **optional** **“Reset** **template”**); **uses** **`scene.set_lights_in_sphere`** **with** **`on`**, **`color`**, **`brightness_pct`**. |
| REQ-026 | **§3.15** (**axis** **mapping** **for** **`size.width`**, **`size.height`**, **`size.depth`**), **§3.17** (**Python** **`scene.width`**, **`scene.height`**, **`scene.depth`** **from** **`GET …/dimensions`**), **§4.13** (**reference** **+** **bottom** **catalog**). |
| REQ-027 | **§4.13** (**visual** **debug** **panel:** **`SceneLightsCanvas`** **reuse** **§4.9**, **scene** **`<select>`**, **Reset** **scene** **lights** **→** **`PATCH …/lights/state/scene`**, **Reset** **camera** **→** **`applyDefaultFraming`**), **§8.18**; **resolved** **open** **questions:** **reset** **lights** **does** **not** **auto-stop** **run**; **debug** **viewport** **works** **with** **or** **without** **active** **run**. |
| REQ-028 | **§4.7** **(**emissive** **mapping** **+** **scene** **lights**)**, **§4.9** **(**composite** **reuse**)**, **§4.13** **(**Python** **debug** **viewport**)**, **§6.5** **(**browser** **GPU** **on** **Pi** **and** **other** **clients**)**, **§8.5**, **§8.7** **(**material** **updates** **after** **PATCH**)**. |
...
### 3.17 Python scene routines — editor, Pyodide worker, `scene` shim, loop, and forced stop (**REQ-022**)
...
**`scene` API (Python, bound per run):** **Inject** **a** **`scene`** **object** **into** **the** **user’s** **globals** **before** **each** **iteration** **(or** **once** **per** **worker** **lifetime** **with** **captured** **`sceneId`)**. **Implementation** **is** **a** **thin** **layer** **over** **`pyodide.ffi.to_js`** **and** **`js.fetch`** **to** **same-origin** **`/api/v1/scenes/{sceneId}/…`**. **Canonical** **mapping** **(names** **in** **§4.13** **reference** **panel** **MUST** **match** **these** **or** **document** **aliases**)**:**
...
### 4.7 Three.js visualization on model detail (**REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-028**)
...
#### State sync (REQ-012 rule 3; REQ-029 observer path)
...
### 4.9 Scenes UI and composite three.js (**REQ-015**, **REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-021**, **REQ-022**, **REQ-023**, **REQ-027**, **REQ-028**, **REQ-029**)
...
- **Live updates while a routine runs (REQ-012, REQ-029):** **While** **`/scenes/[id]`** **is** **mounted** **and** **`GET …/routines/runs`** **shows** **`running`**, **poll** **`GET /api/v1/scenes/{id}`** **every** **`≤ 2 s`** **(architectural** **default** **between** **§4.7** **5** **s** **and** **built-in** **routine** **1** **s** **cadence**)** **and** **merge** **`items[].lights`** **into** **`SceneLightsCanvas`** **state** **so** **REQ-012** **is** **not** **indefinitely** **stale** **during** **automation**. **For** **`python_scene_script`**, **the** **Pyodide** **worker** **(§3.17)** **also** **drives** **updates** **via** **`fetch`** **—** **polling** **remains** **the** **source** **of** **truth** **for** **other** **tabs** **and** **for** **merging** **server** **state** **into** **the** **canvas**. **Stop** **polling** **when** **no** **run** **is** **active** **or** **on** **unmount**. **Integrators** **updating** **the** **same** **scene** **at** **high** **frequency** **via** **§3.15** **SHOULD** **use** **bulk**/**batch** **routes** **(**§3.18**)** **rather** **than** **per-light** **model** **`PATCH`** **storms**; **optional** **scene-scoped** **SSE** **(**§3.18**/**§8.19**)** **reduces** **need** **for** **faster** **polling** **when** **implemented**.
...
### 4.13 Python routine editor, visual debug, on-page reference, and bottom API catalog (**REQ-022**–**REQ-028**, **REQ-023**)

- **Routes (App Router):** **`/routines/python/[id]`** **(edit** **existing** **—** **primary** **destination** **after** **creating** **a** **`python_scene_script`** **row** **via** **§4.12**)**. **`/routines/python/new`** **MAY** **remain** **as** **a** **redirect** **to** **`/routines/new`** **with** **`type`** **pre-selected** **or** **as** **a** **bookmarkable** **helper** **that** **immediately** **`POST`s** **a** **placeholder** **definition** **then** **redirects** **to** **`/routines/python/[id]`** **—** **it** **MUST** **not** **be** **the** **only** **documented** **primary** **way** **to** **start** **a** **new** **Python** **routine** **(REQ-023** **—** **canonical** **create** **UX** **is** **§4.12** **`type`** **dropdown**)**. **Vertical** **page** **order** **(REQ-002** **—** **primary** **workflow** **first**, **REQ-024** **—** **catalog** **last):** **(1)** **toolbar** **+** **persistence** **actions**; **(2)** **run** **scene** **selector** **+** **Start**/**Stop**; **(3)** **visual** **debug** **block** **(REQ-027)** **below** **run** **controls**; **(4)** **editor** **and** **side**/**tab** **reference** **panel** **(REQ-022)**; **(5)** **bottom** **`<section id="python-scene-api-catalog">`** **(REQ-024)** **after** **all** **of** **the** **above**. **Desktop** **MAY** **use** **split** **panes** **for** **(4)** **only**; **the** **catalog** **still** **appears** **after** **those** **panes** **in** **DOM** **order**. **Mobile** **—** **tabs** **or** **accordion** **for** **editor** **vs** **short** **help** **(REQ-002)** **with** **the** **catalog** **as** **the** **final** **accordion** **panel** **or** **scroll** **target**.
- **Editor** **stack** **(mandatory** **per** **REQ-022):** **CodeMirror** **6** **only** — **Primary** **pattern** **in** **this** **repo:** **client** **component** **(e.g.** **`web/components/PythonCodeMirrorEditor.tsx`)** **creates** **`EditorView`** **in** **`React.useEffect`**, **`EditorState.create({ doc, extensions })`** **with** **`basicSetup`** **from** **`codemirror`**, **`python()`** **from** **`@codemirror/lang-python`**, **`lintGutter`**/**`linter`**/**`autocompletion`** **from** **`@codemirror/lint`** **/** **`@codemirror/autocomplete`**, **`oneDark`** **(or** **equivalent)** **from** **`@codemirror/theme-one-dark`**, **`keymap.of([indentWithTab])`**, **and** **`EditorView.updateListener`** **for** **`onChange`**; **sync** **external** **`value`** **when** **it** **differs** **from** **the** **document** **(e.g.** **after** **`GET /api/v1/routines/{id}`)**. **Alternatives:** **a** **thin** **React** **wrapper** **such** **as** **`@uiw/react-codemirror`** **MAY** **replace** **hand-rolled** **`EditorView`** **lifecycle** **if** **the** **buffer** **remains** **pure** **CodeMirror** **6**. **Do** **not** **use** **Monaco** **or** **other** **non-CodeMirror** **editors**. **Wire** **`scene.`** **completion** **from** **a** **manifest** **matching** **§3.17** **(parameter** **snippets** **for** **novices)**. **Format** **button** **and/or** **format-on-save** **per** **§3.17**.
- **Default** **template** **(REQ-025):** **Define** **`PYTHON_ROUTINE_DEFAULT_SOURCE`** **(or** **equivalent)** **in** **`web/`** **as** **the** **initial** **`doc`** **when** **the** **client** **creates** **`python_scene_script`** **with** **`python_source: ""`** **(or** **omit** **and** **let** **client** **substitute** **before** **`PATCH`)** **—** **content** **MUST** **demonstrate** **`await scene.set_lights_in_sphere(...)`** **(or** **sync** **wrapper** **if** **architecture** **uses** **sync** **shim)** **with** **a** **reasonable** **`center`** **and** **`radius`** **inside** **typical** **scene** **bounds**, **setting** **`on`**, **`color`** **(canonical** **`#rrggbb`)**, **and** **`brightness_pct`** **for** **lights** **in** **that** **sphere** **only**. **Optional** **toolbar** **“Reset** **to** **template”** **MAY** **replace** **the** **buffer** **with** **this** **constant** **after** **confirm**.
- **Reference** **panel** **(novice-first,** **REQ-022):** **Structured** **sections** **—** **“What** **is** **`scene`?”**, **“Read** **scene** **size”** **(`scene.width`**, **`scene.height`**, **`scene.depth`** **—** **REQ-026** **+** **§3.15** **axis** **mapping)**, **“Find** **lights** **in** **a** **sphere”** **(`get_lights_within_sphere`**)**, **cuboid** **variants**, **batch** **updates**, **minimal** **copy-paste** **examples** **using** **`async`/`await`** **if** **the** **shim** **is** **async**. **Anchor** **links** **from** **inline** **“?”** **chips** **next** **to** **toolbar** **actions** **optional**.
- **Bottom** **API** **catalog** **(REQ-024):** **Rendered** **from** **the** **same** **ordered** **manifest** **as** **§3.17** **table** **rows** **(every** **`scene`** **property** **and** **method)**. **Each** **row:** **name** **+** **one-line** **description** **+** **`<pre>`** **or** **syntax-highlighted** **snippet** **(may** **reuse** **a** **read-only** **CodeMirror** **`EditorView`** **or** **plain** **`<pre>`**)**. **Heading** **e.g.** **“Scene** **API** **reference** **(complete)”** **with** **anchor** **`#python-scene-api-catalog`**. **Implementor** **MUST** **keep** **manifest** **and** **§3.17** **in** **sync** **(single** **TS** **module** **exporting** **rows** **recommended)**.
- **Visual** **debug** **(REQ-027):** **Dedicated** **region** **on** **the** **same** **page** **with:** **(a)** **`GET /api/v1/scenes`** **populated** **`<select>`** **(or** **combobox)** **—** **choice** **is** **the** **debug** **target** **scene** **(independent** **of** **whether** **it** **matches** **the** **run** **scene** **selector** **—** **user** **may** **align** **them** **manually** **or** **implementor** **MAY** **default** **debug** **selection** **to** **run** **scene** **when** **both** **are** **set)**; **(b)** **`SceneLightsCanvas`** **from** **§4.9** **fed** **by** **`GET /api/v1/scenes/{id}`** **(or** **equivalent** **detail** **payload** **with** **per-light** **state** **+** **`sx/sy/sz`)**; **(c)** **after** **each** **successful** **`PATCH`** **from** **the** **Pyodide** **worker** **for** **that** **`sceneId`**, **host** **`postMessage`** **or** **lightweight** **`GET /api/v1/scenes/{id}/lights`** **or** **`GET /api/v1/scenes/{id}`** **to** **merge** **state** **into** **the** **canvas** **so** **the** **view** **tracks** **REQ-012** **and** **REQ-028** **timeliness** **(same** **class** **as** **model** **detail** **—** **no** **indefinite** **staleness** **after** **confirmed** **writes)**; **(d)** **Reset** **scene** **lights** **button** **(Font** **Awesome** **icon** **+** **label** **e.g.** **“Reset** **scene** **lights”)** **→** **`PATCH /api/v1/scenes/{debugSceneId}/lights/state/scene`** **with** **`{ "on": false, "color": "#ffffff", "brightness_pct": 100 }`** **(REQ-014** **triple)** **then** **merge** **response** **into** **canvas**; **does** **not** **call** **`POST …/stop`** **—** **if** **a** **run** **is** **active**, **user** **stops** **separately** **or** **accepts** **that** **the** **next** **iteration** **may** **re-apply** **effects**; **(e)** **Reset** **camera** **button** **→** **same** **`applyDefaultFraming`** **as** **§4.9**/**§4.7** **(REQ-016** **—** **client-only)**. **Visual** **debug** **works** **with** **no** **run** **(static** **inspection**) **and** **with** **an** **active** **run** **(live** **updates)**.
...
- **Run** **against** **scene:** **Scene** **selector** **(or** **“Use** **current** **scene”** **when** **navigated** **from** **`/scenes/[id]`** **via** **query** **`?scene=id`)** **+** **Start** **calls** **`POST …/scenes/{sceneId}/routines/{routineId}/start`** **then** **attaches** **§3.17** **worker** **with** **`sceneId`**, **`runId`**, **`routineId`**. **Stop** **calls** **`POST …/stop`** **then** **cooperative** **shutdown** **then** **`worker.terminate()`** **after** **`T_force`** **if** **needed**.
- **REQ-018:** **Toolbar** **buttons** **(Save,** **Format,** **Run/Stop,** **Duplicate,** **Delete,** **Reset** **scene** **lights,** **Reset** **camera** **where** **present)** **each** **include** **a** **visible** **Font** **Awesome** **icon**.
...
### 8.17 Python routine: start, Pyodide worker loop, scene API fetch, cooperative and forced stop (**REQ-022**, **§3.17**)
...
### 8.18 Python routine page: visual debug sync and scene resets (**REQ-027**, **REQ-028**, **§4.13**)
...
sequenceDiagram
  ...
  loop Each successful worker PATCH for that scene
    ...
    Page->>G: GET /api/v1/scenes/{debugId}/lights (or GET scene detail)
...
| REQ-024 | §4.13 (`#python-scene-api-catalog`, manifest sync with §3.17) |
| REQ-025 | §4.13 (`PYTHON_ROUTINE_DEFAULT_SOURCE`, sphere colour demo) |
...
| REQ-029 | §1, §3.2, §3.10, §3.15, §3.18, §4.3, §4.7, §4.9, §6, §7, §8.19, §9 |

---

**Next step:** After **material** **code** **or** **requirement** **changes**, invoke **`@implementor`** **then** **`@verifier`** **to** **keep** **tests**, **`docs/traceability_matrix.md`**, **and** **this** **document** **aligned**. **REQ-022** **editor** **surface** **is** **implemented** **with** **`EditorView`**, **`codemirror`** **`basicSetup`**, **and** **`@codemirror/*`** **per** **§3.17** **and** **§4.13** **above**. **REQ-023** **is** **satisfied** **by** **the** **§4.12** **create** **flow** **(single** **`type`** **dropdown** **including** **Python**)** **without** **a** **redundant** **primary** **Python-only** **create** **button**. **REQ-024**–**REQ-027** **are** **specified** **in** **§3.15**, **§3.17**, **§4.13**, **and** **§8.18** **as** **above**. **REQ-028** **is** **specified** **in** **§4.7**, **§4.9**, **§4.13**, **§6.5**, **and** **§8.5**/**§8.7** **above**. **REQ-029** **is** **specified** **in** **§3.18**, **with** **cross-references** **in** **§4.3**, **§4.7**, **§4.9**, **and** **§8.19**.
