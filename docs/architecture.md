...
| REQ-021 | **§3.2**, **§3.14**, **§3.15**, **§3.16**, **§4.9**, **§4.11**, **§4.12**, **§8.16**: routine definitions CRUD + scene-scoped start/stop + in-process run scheduler; automation uses **only** **§3.15** **`…/lights/state/*`** **handlers** **or** **the** **same** **`store`** **functions** **they** **call** (**not** **`/models/.../lights`** **for** **routine** **effects**); type **`random_colour_cycle_all`**; **one** active run per scene; **409** on delete while active. |
...
- **Routine scheduler (REQ-021):** The **~1** **s** **`time.Ticker`** **and** **routine** **tick** **logic** **run** **in** **the** **same** **Go** **process** **as** **HTTP** **(§3.16)** — **no** **separate** **daemon** **or** **cron** **for** **MVP**.
