...
| REQ-022 | **§3.2**, **§3.15**, **§3.16** (**schema** **+** **start/stop** **shared** **with** **REQ-021**), **§3.17**, **§4.9** (**link** **to** **editor**), **§4.11** (**nav**), **§4.12** (**list** **entry**), **§4.13**, **§6.2** (**bundle** **size** **note**), **§7**, **§8.17**: **`python_scene_script`** **+** **`python_source`**; **PATCH** **routine**; **Monaco** **or** **CodeMirror** **6** **+** **Pyodide** **worker** **`scene`** **API** **→** **`fetch`** **§3.15**; **cooperative** **stop** **+** **`worker.terminate()`** **after** **bounded** **wait**. |
...
| API | `POST /api/v1/routines` | Create definition: **`{ "name", "description", "type", "python_source"? }`** — **`name`** and **`type`** **non-empty** **trimmed**; **`description`** **string** **(may** **be** **`""`)**. **When** **`type`** **is** **`python_scene_script`**, **`python_source`** **MUST** **be** **present** **(string,** **UTF-8** **text;** **empty** **allowed** **but** **run** **may** **fail** **with** **clear** **client**/**server** **error)**. **201** + full row. Unknown **`type`** → **400**. **REQ-021**, **REQ-022** |
...
**UI support:** **§4.12** (**list** **+** **create** **non-Python** **types**); **§4.13** (**Python** **authoring** **+** **docs**); **§4.9** (**start/stop** **any** **type** **on** **scene**).
...
| Python surface (illustrative) | HTTP (§3.15) |
|-------------------------------|--------------|
| **`scene.height`** **(float,** **meters)** | **`GET …/dimensions`** **→** **`size.height`** |
...
**Editor** **(§4.13):** **Monaco** **or** **CodeMirror** **6** **with** **Python** **grammar**; **diagnostics** **via** **Pyodide** **`ast.parse`** **on** **debounced** **save**/**run** **or** **optional** **Pyright** **worker** **if** **bundle** **budget** **allows**; **completion** **for** **`scene.`** **methods** **from** **a** **static** **manifest** **derived** **from** **the** **table** **above**; **format** **on** **save** **via** **`black`** **in** **Pyodide** **when** **available**, **else** **indent** **normalization** **only** **—** **defaults** **on** **per** **REQ-022**.
...
### 4.9 Scenes UI and composite three.js (**REQ-015**, **REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-021**, **REQ-022**)
...
- **Create:** **Form** **POST** **`/api/v1/routines`** **with** **name** **(required)**, **description** **(optional** **empty** **string)**, **type** **`<select>`** **with** **at** **least** **`random_colour_cycle_all`** **(label** **e.g.** **“Random** **colour** **cycle** **(all** **lights)”)** **and** **`python_scene_script`** **(label** **e.g.** **“Python** **(scene** **API)”)** **—** **when** **Python** **is** **chosen**, **either** **collect** **`python_source`** **in** **a** **textarea** **on** **the** **same** **form** **or** **redirect** **to** **`/routines/python/new`** **after** **create** **(§4.13)** **—** **reject** **unknown** **types** **client-side** **to** **match** **server** **400**.
...
### 4.13 Python routine editor and on-page library reference (**REQ-022**)

- **Routes (App Router):** **`/routines/python/new`** **(create** **empty** **definition** **then** **PATCH** **or** **single** **POST** **with** **`python_scene_script`** **+** **initial** **source)**, **`/routines/python/[id]`** **(edit** **existing)**. **Layout** **MUST** **keep** **the** **code** **editor** **and** **the** **reference** **documentation** **on** **the** **same** **logical** **page** **(REQ-022** **rule** **6**)**:** **desktop** **—** **split** **pane** **(e.g.** **60/40** **or** **resizable** **`react-resizable-panels`)**; **mobile** **—** **tabs** **“Code”** **/** **“Scene** **API** **help”** **or** **accordion** **with** **sticky** **tab** **bar** **(REQ-002**)**.
- **Editor** **stack** **(implementor** **chooses** **one** **primary):** **Monaco** **via** **`@monaco-editor/react`** **or** **CodeMirror** **6** **with** **`@codemirror/lang-python`**, **`@codemirror/autocomplete`**, **`@codemirror/lint`**. **Wire** **completion** **sources** **for** **`scene.`** **members** **from** **a** **generated** **manifest** **that** **matches** **§3.17** **table** **(parameter** **snippets** **for** **novices)**. **Format** **button** **and/or** **format-on-save** **per** **§3.17**.
- **Reference** **panel** **(novice-first):** **Structured** **sections** **—** **“What** **is** **`scene`?”**, **“Read** **scene** **size”** **(`scene.height`**, **`dimensions`)**, **“Find** **lights** **in** **a** **sphere”** **(`get_lights_within_sphere`**)**, **cuboid** **variants**, **batch** **updates**, **minimal** **copy-paste** **examples** **using** **`async`/`await`** **if** **the** **shim** **is** **async**. **Anchor** **links** **from** **inline** **“?”** **chips** **next** **to** **toolbar** **actions** **optional**.
...
- **REQ-018:** **Toolbar** **buttons** **(Save,** **Format,** **Run/Stop,** **Duplicate,** **Delete)** **each** **include** **a** **visible** **Font** **Awesome** **icon**.
...
**Next step:** Invoke **`@implementor`** to implement **§3.17** (**`python_source`** **column** **+** **migration**, **`python_scene_script`** **type**, **`PATCH /api/v1/routines/{id}`**, **scheduler** **skip** **for** **Python**, **start** **semantics** **without** **server** **ticks**), **Pyodide** **worker** **+** **`scene`** **shim** **+** **editor**/**docs** **per** **§4.13**, **scene** **detail** **integration** **§4.9**, **and** **forced** **stop** **ordering** **documented** **in** **§3.17**. **Existing** **§3.15**/**§3.16**/**§4.12** **work** **remains** **as** **documented** **for** **`random_colour_cycle_all`**. After implementation, invoke **`@verifier`** to audit, run tests, and update **`docs/traceability_matrix.md`**.
