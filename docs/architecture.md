...
| REQ-010 | **`three`** direct; **client-only** detail: **InstancedMesh** (or equivalent **§4.7**) **ø 0.02 m** markers for **all n** lights (**no** LOD/decimation); **`LineSegments`** **i↔i+1** only (**chain**); segment colour **`#D0D0D0`**, **opacity 0.15** (**85%** transparent), thinner/subtler than spheres; **`Raycaster`** + **DOM** tooltip (**§4.7**). **REQ-034** **reuses** **this** **visual** **recipe** **for** **the** **model** **boundary** **cuboid** **(**§4.7** **subsection**)**. |
...
| REQ-015 | **`scenes`** **(**incl.** **`boundary_margin_m`** **default** **0.3** **m** **—** **§3.12**)** **+** **`scene_models`**; **`POST /scenes`** **computes** **offsets**; **`GET`/`PATCH` `/scenes/{id}`** **expose**/**edit** **margin** **(**§3.13**)**; **`GET /models/{id}`** **unchanged**; **`GET /scenes/{id}`** **returns** **`x,y,z`** **+** **`sx,sy,sz`**; **composite** **three.js** **§4.9** **+** **REQ-034** **boundary**; **409** **`model_in_scenes`** (**§3.2**, **§8.4**). |
...
| REQ-017 | **`POST /api/v1/system/factory-reset`** (**§3.2**, **§3.14**); **`store.FactoryReset`** **transaction** **deletes** **`routine_runs`** **+** **`routines`** **(**including** **`shape_animation`** **rows**)** **before** **scenes**/**models** **then** **`SeedDefaultSamples`** **+** **`SeedDefaultPythonRoutines`** (**§3.8.1**); **Options** **route** **§4.10** **+** **modal** **before** **POST**; **post-success** **navigate** **`/models`** **+** **success** **message** (**architectural** **default** **for** **REQ-017** **open** **question**). |
...
| REQ-021 | **§3.2**, **§3.14**, **§3.15**, **§3.16**, **§3.17**, **§3.17.2**, **§4.9**, **§4.11**, **§4.12**, **§4.14**, **§8.16**/**§8.17**/**§8.21**/**§8.22**: **Two** **routine** **kinds** **—** **`python_scene_script`** **(**§3.17**)** **and** **`shape_animation`** **(**§3.17.2**)**; **scene-scoped** **start**/**stop**; **light** **mutations** **only** **through** **§3.15** **scene** **routes** **(**Python** **via** **`scene`** **shim** **/** **shape** **via** **host** **`fetch`** **to** **same** **endpoints**)** **—** **not** **`/models/.../lights`** **for** **routine** **effects**; **no** **in-process** **Go** **routine** **simulation** **ticker** **(**engines** **run** **in** **the** **browser**)**; **one** **active** **run** **per** **scene**; **409** **on** **delete**/**PATCH** **while** **active**. |
...
| REQ-030 | **§3.17** (**`scene.random_hex_colour()`** **—** **local** **`random.randrange(0x1000000)`** **+** **`"#%06x"`** **formatting** **in** **Pyodide**), **§4.13** (**REQ-024** **manifest** **row** **+** **novice** **sample**; **`pythonRoutineCodemirror`** **completion**), **`web/lib/pythonSceneApiCatalog.ts`**, **`public/dlm-python-scene-worker.mjs`** **(**stay** **aligned** **with** **`scene.max_*`** **when** **present**)**. |
| REQ-031 | **§3.9**, **§3.10**, **§3.15** **(**bulk** **no-op** **short-circuit**)**, **§3.16**, **§3.17.2** (**optional** **host** **short-circuit** **before** **`fetch`**)**, **§3.18**, **§3.19**, **§4.7**, **§4.9**, **§4.13**, **§4.14**, **§8.7**, **§8.8**, **§8.20** **(**equivalence** **before** **visualization** **and** **persistence**; **future** **WLED** **hook** **documented** **in** **§3.19**)**. |
...
| REQ-033 | **§3.16** **(**schema** **+** **`POST`/`PATCH`**)**, **§3.17.2** **(**simulation** **engine** **+** **geometry** **resolution**)**, **§4.12**, **§4.14**, **§6.2** **(**no** **Pyodide** **—** **lighter** **than** **Python** **authoring**)**, **§8.21**, **§8.22** **(**unified** **viewport** **+** **tick** **writes** **via** **§3.15**)**. |
| REQ-034 | **§3.12** **(**`boundary_margin_m`** **column**)** ,** **§3.13** **(**`PATCH` **scene** **metadata**)** ,** **§3.15** **(**`GET …/dimensions`** **`margin_m`** **=** **persisted** **`m`**)**, **§4.7** **(**model** **view:** **fixed** **0.3** **m** **padding** **on** **tight** **light** **AABB**)** ,** **§4.9** **/** **§4.13** **/** **§4.14** **(**scene** **embedded** **previews:** **`m`** **from** **scene** **record**)** ,** **§8.7** **(**boundary** **mesh** **rebuild** **when** **lights** **or** **`m`** **change**)**. |
...
- **`internal/httpapi`:** Middleware (**request ID**, **slog**, **recover**, optional **CORS**); **JSON** handlers and error envelope `{ "error": { "code", "message", "details"? } }`; **models**, **light-state**, **scenes**, **scene-region** routes (**§3.15**), and **routines**/**routine-runs** (**§3.16**, **§3.17**, **§3.17.2**) delegate to **`internal/store`** and **`internal/wiremodel`**; **routine** **automation** **has** **no** **in-process** **Go** **simulation** **ticker** **(**Python** **runs** **in** **Pyodide** **§3.17**; **shape** **animation** **in** **browser** **main** **thread** **or** **worker** **without** **Python** **§3.17.2**)**. **High-throughput** **light** **update** **and** **connection-reuse** **guidance** **for** **integrators** **and** **reverse-proxy** **deployment** **is** **§3.18** (**REQ-029**).
- **`internal/wiremodel`:** Parses and validates uploaded **CSV** per **§3.6**; returns structured errors for HTTP **400** responses (**REQ-007**).
- **`internal/store`:** **SQLite** repository (see **§3.3**, **§3.12**, **§3.16**); opened at process start; migrations or `CREATE IF NOT EXISTS` for schema (**REQ-006**); **idempotent default seed** when no models exist (**§3.8**, **REQ-009**) **and** **`SeedDefaultPythonRoutines`** when **`routines`** **is** **empty** (**§3.8.1**, **REQ-032**); **scene** CRUD and **reference** checks for **model** **delete** (**REQ-015**, **REQ-006** rule **5**); **routines** (**`python_scene_script`** **+** **`python_source`** **/** **`shape_animation`** **+** **`definition_json`**, **§3.16**/**§3.17.2**) and **`routine_runs`** persistence (**§3.16**).
...
| API | `GET /api/v1/scenes/{id}` | Scene **metadata** **(**incl.** **`boundary_margin_m`**) **+** **placements** + **full** **lights** (positions + state) **per** **model** for **one** **round-trip** (**§3.13**). **REQ-015**, **REQ-034** |
| API | `PATCH /api/v1/scenes/{id}` | **Update** **scene** **metadata** **(**at** **minimum** **`boundary_margin_m`** **—** **REQ-015** **rule** **13**)**; **does** **not** **change** **light** **rows** **or** **`scene_models`** **offsets** **(**§3.13**)**. **REQ-015**, **REQ-034** |
...
| API | `GET /api/v1/scenes/{id}/dimensions` | Return scene-space dimensions: **`origin`**, **`size`**, **`max`**, **`margin_m`** **=** **`boundary_margin_m`** **(**§3.15**)**. **REQ-020**, **REQ-033**, **REQ-034** |
...
| API | `POST /api/v1/system/factory-reset` | **REQ-017:** **no** body (or **`{}`**). **One** **transaction** **per** **§3.14** **(**deletes** **`routine_runs`**, **`routines`**, **then** **scenes**/**models**/**lights** **in** **FK-safe** **order**)** **then** **`SeedDefaultSamples`** **(**§3.8**)** **and** **`SeedDefaultPythonRoutines`** **(**§3.8.1**)**. **200** **`{ "ok": true }`**. **500** **only** **on** **unexpected** **store** **failure** **(no** **partial** **wipe** **visible** **after** **commit**)**. **Register** **before** **any** **`{id}`** **catch-alls** **so** **`system`** **is** **not** **parsed** **as** **an** **id**. |
...
| Table | Columns | Notes |
|-------|---------|--------|
| **`scenes`** | `id` (TEXT **UUID** PK), `name` (TEXT **NOT NULL**, **UNIQUE**), `created_at` (TEXT **RFC3339** UTC), **`boundary_margin_m`** **REAL** **NOT** **NULL** **default** **0.3** | One row per scene. **`boundary_margin_m`** **=** **`m`** **(**REQ-015** **rules** **12–13**, **REQ-034**)** **:** **symmetric** **padding** **(**SI** **m**)** **on** **all** **six** **faces** **for** **the** **faint** **boundary** **cuboid** **and** **for** **`GET …/dimensions`** **(**§3.15**)**. **Migration:** **add** **column** **with** **default** **0.3** **;** **reads** **without** **column** **(**legacy** **DB**)** **fall** **back** **to** **0.3**. **No** row without **≥ 1** **`scene_models`** row **after** successful **create** (**transaction**). |
...
**Automatic bounds / margin for camera framing (REQ-015, distinct from REQ-034):** Let **`Mmax_x`**, **`Mmax_y`**, **`Mmax_z`** be the **maxima** **of** **`sx`**, **`sy`**, **`sz`** **respectively** **over** **all** **lights** **in** **the** **scene**. The **default** **camera** **framing** **helper** **(**`applyDefaultFraming`**, **§4.9**)** **SHOULD** **fit** **a** **box** **that** **includes** **at** **least** **1** **m** **padding** **beyond** **those** **maxima** **on** **each** **positive** **axis** **from** **origin** **`(0,0,0)`** **(**legacy** **“comfort”** **framing** **—** **unchanged** **unless** **product** **later** **unifies** **with** **REQ-034**)**. **REQ-034** **boundary** **cuboid** **(**§4.9**)** **is** **instead** **the** **tight** **light** **AABB** **(**min** **and** **max** **per** **axis** **over** **`sx,sy,sz`**)** **expanded** **by** **the** **scene’s** **persisted** **`boundary_margin_m`** **`m`** **(**default** **0.3** **m**)** **—** **not** **the** **same** **as** **this** **1** **m** **framing** **slack** **unless** **implementor** **chooses** **to** **merge** **the** **two** **concepts** **explicitly** **in** **code** **and** **tests**.
...
**`GET /api/v1/scenes/{id}`** — **`200`:** **`{ "id", "name", "created_at", "boundary_margin_m", "items": [ … ] }`** **(**same** **`items`** **shape** **as** **before**:** **each** **`{ "model_id", "name", "offset_x", "offset_y", "offset_z", "lights": [ { "id", "x", "y", "z", "sx", "sy", "sz", "on", "color", "brightness_pct" }, … ] }`**)**. **`boundary_margin_m`** **MUST** **be** **the** **stored** **`m`** **(**finite**,** **≥** **0**)** **—** **REQ-015** **/** **REQ-034**. **`x`, `y`, `z`** **MUST** **match** **persisted** **`lights`** **(canonical** **REQ-005**)**; **`sx`, `sy`, `sz`** **MUST** **equal** **canonical** **+** **offsets** **(derived)**. **Scene** **tooltip**/**labels** **SHOULD** **show** **both** **scene** **and** **model-local** **coordinates** **where** **space** **allows** (**§4.9**). **`PATCH /api/v1/scenes/{id}/models/{modelId}`** **updates** **only** **`scene_models`** **offsets** **—** **never** **`lights`**.**

**`PATCH /api/v1/scenes/{id}`** — **Scene** **metadata** **only** **(**REQ-015** **rule** **13**)** **:** **body** **`{ "boundary_margin_m": number }`** **with** **at** **least** **this** **field** **(**implementor** **MAY** **allow** **future** **fields** **e.g.** **`name`** **in** **the** **same** **endpoint** **or** **split** **—** **document** **choice**)**. **Validate** **`boundary_margin_m`:** **finite**, **`≥ 0`**, **optional** **upper** **cap** **e.g.** **`≤ 10`** **m** **(**prevents** **absurd** **values** **and** **float** **noise** **in** **UI**)**. **`200`** **returns** **updated** **scene** **summary** **or** **the** **same** **shape** **as** **`GET …/scenes/{id}`** **without** **`items`** **(**implementor** **chooses** **—** **client** **detail** **page** **SHOULD** **merge** **`boundary_margin_m`** **into** **local** **state** **and** **rebuild** **§4.9** **boundary** **mesh** **without** **full** **reload**)**. **`404`** **if** **unknown** **scene**.
...
9. **Run** **`SeedDefaultPythonRoutines`** **(**§3.8.1**)** **on** **the** **same** **transaction** **—** **insert** **exactly** **three** **`python_scene_script`** **rows** **with** **the** **canonical** **sample** **sources**.
10. **`COMMIT`**.

**Invariants:** **No** **commit** **unless** **steps** **2–9** **all** **succeed**; **on** **error**, **`ROLLBACK`** **and** **return** **500** **with** **a** **generic** **message** **(client** **may** **offer** **retry** **copy**)**.** **After** **200**, **`GET /api/v1/models`** **lists** **only** **the** **three** **samples**; **`GET /api/v1/scenes`** **is** **empty**; **`GET /api/v1/routines`** **lists** **exactly** **the** **three** **default** **Python** **sample** **routines** **(**§3.8.1**)**.
...
- **`GET /api/v1/scenes/{id}/dimensions`** returns the **axis-aligned bounding box** of **all** lights in **scene space** (**`sx/sy/sz`**), expanded by **`margin_m`** on **each** side. **Architectural** **resolution** **(**closes** **requirements** **open** **question**)**:** **`margin_m`** **in** **this** **JSON** **MUST** **equal** **the** **scene’s** **persisted** **`boundary_margin_m`** **`m`** **(**REQ-015** **/** **REQ-034**)** **—** **same** **scalar** **used** **for** **the** **faint** **boundary** **cuboid** **in** **§4.9** **and** **for** **§3.17.2** **shape** **animation** **(**so** **Python**,** **shape** **routines**,** **region** **queries**,** **and** **the** **viewport** **stay** **consistent** **when** **the** **user** **changes** **`m`** **)**.
  - `origin`: **`{ "x", "y", "z" }`** = **lower** corner (**`min(sx) − margin_m`** per axis — **no** **clamp** **at** **0** **so** **`origin`..`max`** **matches** **the** **REQ-034** **padded** **light** **AABB** **and** **shape** **animation** **bounds** **(**negative** **coordinates** **are** **valid** **scene** **space** **when** **padding** **extends** **below** **the** **non-negative** **light** **footprint**)**).
  ...
  - `margin_m`: **non-negative** **finite** **SI** **meters** **—** **read** **from** **`scenes.boundary_margin_m`** **(**default** **0.3** **when** **missing** **on** **legacy** **rows**)**.
...
- **No** **`time.Ticker`** **or** **in-process** **Go** **routine** **simulation:** **Python** **mutations** **run** **in** **the** **browser** **Pyodide** **loop** **(**§3.17**)**; **shape** **animation** **mutations** **run** **in** **the** **browser** **host** **loop** **(**§3.17.2**)**. **Both** **only** **invoke** **§3.15** **over** **`fetch`**.
- **Concurrency:** **At** **most** **one** **`routine_runs`** **row** **with** **`status = 'running'`** **per** **`scene_id`** **(**whether** **the** **routine** **is** **Python** **or** **shape** **animation**)**. **Second** **start** **on** **same** **scene** **→** **`409`** **`scene_routine_conflict`**.
...
| Table | Columns | Notes |
|-------|---------|--------|
| **`routines`** | `id` (TEXT **UUID** PK), `name`, `description`, `type` (**`python_scene_script`** \| **`shape_animation`** \| **legacy**), `python_source` (TEXT **NOT** **NULL**, **`""`** **allowed**), `definition_json` (TEXT **NULL** — **required** **non-null** **for** **`shape_animation`** **rows**), `created_at` | **Migration** **adds** **`definition_json`** **if** **missing**; **backfill** **`NULL`** **for** **existing** **Python** **rows**. |
| **`routine_runs`** | *(unchanged)* | **One** **`running`** **per** **`scene_id`**. |

**Execution model:** **`POST …/start`** **inserts** **`running`** **;** **Go** **does** **not** **apply** **light** **patches** **by** **itself**. **Python** **:** **client** **starts** **Pyodide** **worker** **(**§3.17**)**. **Shape** **animation** **:** **client** **starts** **§3.17.2** **timer**/**`requestAnimationFrame`** **driver** **(**§4.14**)**. **If** **no** **browser** **tab** **runs** **the** **engine**, **`running`** **may** **persist** **without** **effects** **(**document** **in** **help** **copy**)**.

**REQ-021** **(**scene** **API** **only** **for** **automation**)**:** **Neither** **kind** **may** **use** **`PATCH /api/v1/models/{id}/lights/…`** **for** **routine** **effects**. **Python** **uses** **the** **`scene`** **shim**; **shape** **animation** **uses** **direct** **`fetch`** **to** **the** **same** **§3.15** **URLs**.
...
**Server-side** **shape** **engine:** **Out** **of** **scope** **—** **validation** **of** **`definition_json`** **on** **`POST`/`PATCH`** **only** **(**§3.17.2**)**; **simulation** **runs** **client-side**.

### 3.17 Python scene routines — editor, Pyodide worker, `scene` shim, loop, and forced stop (**REQ-022**, **REQ-026**, **REQ-030**, **REQ-032**)
...
**Loop** **(**`python_scene_script` **only**)** **:** **After** **`POST …/start`** **returns** **`201`**, **the** **UI** **that** **initiated** **start** **(or** **the** **scene** **detail** **page** **when** **it** **detects** **an** **active** **run** **via** **`GET …/routines/runs`)** **spawns** **(or** **reuses)** **the** **Pyodide** **worker**, **loads** **`python_source`**, **and** **repeatedly** **`exec`** **or** **`runPythonAsync`** **the** **script** **body** **until** **stopped** **(**§3.16**)**. **Shape** **animation** **runs** **use** **§3.17.2** **instead** **(**no** **Pyodide**)**. **Default** **gap** **between** **iterations:** **`asyncio.sleep(0.05)`** **(50** **ms)** **—** **tunable** **later** **via** **optional** **UI** **setting**; **document** **in** **README**. **Scripts** **that** **need** **~1** **s** **wall-clock** **steps** **(**e.g.** **REQ-032** **random** **colour** **cycle**)** **use** **`time.monotonic()`** **/** **`asyncio.sleep`** **inside** **the** **script** **(**§3.17.1**)** **in** **addition** **to** **or** **instead** **of** **relying** **only** **on** **the** **50** **ms** **host** **gap**.
...
### 3.17.2 Shape animation routines — `definition_json`, client simulation, light painting (**REQ-033**, **REQ-020**, **REQ-026**, **REQ-030**, **REQ-034**)

**Placement:** **No** **Pyodide**. **Implement** **as** **a** **pure** **TypeScript** **module** **(e.g.** **`web/lib/shapeAnimationEngine.ts`)** **invoked** **from** **the** **shape** **animation** **page** **(**§4.14**)** **after** **`POST …/start`**. **Optional** **`Worker`** **if** **main-thread** **jank** **on** **low** **devices** **—** **same** **`fetch`** **contract** **either** **way**.
...
**Simulation tick:** **Default** **`Δt = 1/60` s** **(**~**60** **Hz** **client** **loop** **for** **smooth** **motion** **—** **tunable**)**. **Integrate** **`position += velocity * Δt`**. **Boundary** **(**closed** **scene** **AABB** **from** **`GET …/dimensions`:** **`origin.x ≤ x ≤ max.x`**, **same** **for** **`y`,`z`**, **using** **`sx/sy/sz`** **semantics** **for** **shape** **centers**/**corners** **—** **the** **`margin_m`** **in** **that** **response** **tracks** **`boundary_margin_m`** **(**§3.15**)** **so** **simulation** **bounds** **match** **REQ-034** **when** **the** **user** **edits** **`m`** **—** **implementor** **documents** **sphere** **vs** **cuboid** **collision** **test** **against** **that** **box**)** **:**
...
1. **Load** **`GET /api/v1/scenes/{id}/lights`** **(**or** **reuse** **cached** **list** **if** **still** **valid** **—** **must** **refresh** **after** **external** **writes**)**.
2. **For** **each** **active** **shape**, **compute** **inclusion** **in** **scene** **space** **(**same** **inclusive** **rules** **as** **§3.15** **for** **sphere**/**cuboid**)**.
3. **Build** **winning** **(**color**,** **brightness_pct**)** **per** **light** **by** **lowest** **shape** **index** **among** **those** **containing** **the** **light**.
4. **Build** **`updates[]`** **for** **`PATCH …/lights/state/batch`:** **every** **light** **gets** **exactly** **one** **row** **—** **either** **winner** **shape** **(**`on:true`**,** **color**,** **brightness_pct`** **)** **or** **background** **(**`lights_on`** **or** **`on:false`** **)**.
5. **Optional** **§3.19** **optimization:** **compare** **to** **last** **tick’s** **intended** **triples** **and** **skip** **`fetch`** **if** **identical** **(**server** **still** **no-ops** **if** **sent**)**.

**Loop** **termination** **(**REQ-033** **rule** **10**)** **:** **While** **`running`**, **after** **each** **tick**, **if** **no** **active** **shapes** **remain** **(**all** **used** **`stop`**)**, **end** **the** **run** **locally** **and** **`POST …/stop`** **to** **persist** **`stopped`** **(**idempotent**)** **—** **or** **leave** **`running`** **and** **show** **idle** **viewport** **until** **user** **stops** **(**implementor** **chooses** **one** **policy** **and** **documents** **it** **;** **recommended:** **auto** **`POST …/stop`** **when** **terminal** **so** **`scene_runs`** **matches** **REQ-033** **“all** **stopped”** **)**. **If** **any** **shape** **uses** **`wrap`** **or** **deflect** **modes**, **loop** **indefinitely** **until** **user** **`POST …/stop`**.

**Start** **hook:** **After** **`201`** **from** **`POST …/start`**, **page** **loads** **`definition_json`**, **`GET …/dimensions`**, **initial** **light** **list**, **then** **starts** **the** **tick** **loop** **(**§8.22**)**.
...
**Python** **worker** **/** **batch** **paths** **(**§3.15**/**§3.17**)** **and** **internal** **`store`** **calls:** **Reuse** **the** **same** **“compare** **before** **`UPDATE`”** **helper** **so** **repeated** **identical** **scene** **state** **writes** **from** **routines** **do** **not** **touch** **SQLite** **unnecessarily** **(**REQ-031**)**.
...
### 4.7 Three.js visualization on model detail (**REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-028**, **REQ-031**, **REQ-034**)
...
#### Faint boundary cuboid — model view (**REQ-034**)

- **When** **`n ≥ 1`:** **After** **computing** **the** **tight** **axis-aligned** **box** **over** **all** **canonical** **light** **`(x,y,z)`**, **expand** **it** **by** **exactly** **0.3** **m** **on** **every** **face** **(**subtract** **0.3** **from** **each** **min**, **add** **0.3** **to** **each** **max** **)**. **Draw** **the** **12** **edges** **as** **`LineSegments`** **(**or** **`EdgesGeometry`** **on** **a** **transparent** **`BoxGeometry`** **)** **using** **the** **same** **`#D0D0D0`** **/** **`opacity`** **0.15** **recipe** **as** **inter-light** **wires** **(**REQ-010**)** **;** **do** **not** **raycast** **or** **pick** **the** **boundary** **(**optional**)**.
- **When** **`n === 0`:** **No** **boundary** **cuboid** **(**REQ-034** **degenerate** **case**)**.
- **Updates:** **Rebuild** **or** **resize** **the** **boundary** **lines** **whenever** **light** **positions** **change** **(**same** **timeliness** **class** **as** **REQ-012** **for** **state-driven** **mesh** **updates**)**. **Reset** **camera** **(**REQ-016**)** **does** **not** **remove** **the** **boundary**.
...
### 4.9 Scenes UI and composite three.js (**REQ-015**, **REQ-010**, **REQ-012**, **REQ-016**, **REQ-019**, **REQ-021**, **REQ-022**, **REQ-023**, **REQ-027**, **REQ-028**, **REQ-029**, **REQ-031**, **REQ-033**, **REQ-034**)
...
- **Data:** **`GET /api/v1/scenes`**, **`POST /api/v1/scenes`**, **`GET /api/v1/scenes/{id}`**, **`PATCH /api/v1/scenes/{id}`** **(**`boundary_margin_m`** **—** **§3.13**)** ,** **`POST …/models`**, **`PATCH …/models/{modelId}`**, **`DELETE …/models/{modelId}`**, **`DELETE /api/v1/scenes/{id}`** per **§3.13**. **On** **`409`** **`scene_last_model`**, **show** **modal** **copy** **that** **removing** **the** **last** **model** **deletes** **the** **entire** **scene**; **on** **confirm**, **`DELETE /api/v1/scenes/{id}`** **then** **redirect** **to** **`/scenes`**.
- **Boundary** **margin** **control** **(**REQ-015** **rule** **13**, **REQ-034**)** **:** **On** **`/scenes/[id]`**, **next** **to** **or** **above** **the** **composite** **viewport** **(**not** **hover-only** **—** **REQ-002**)** ,** **expose** **`boundary_margin_m`** **as** **a** **numeric** **input** **(**e.g.** **show** **centimeters** **in** **the** **UI** **with** **÷100** **to** **SI** **m** **on** **`PATCH`** **)** **+** **Apply** **/** **Save** **that** **calls** **`PATCH /api/v1/scenes/{id}`**. **On** **success**, **merge** **the** **returned** **value** **into** **page** **state** **and** **refresh** **the** **boundary** **wireframe** **without** **full** **reload**.
- **Faint** **boundary** **cuboid** **(**REQ-034**)** **:** **`SceneLightsCanvas`** **(**or** **shared** **helper** **used** **by** **it**)** **computes** **tight** **AABB** **over** **all** **`sx,sy,sz`** **across** **`items[]`**, **then** **expands** **by** **`boundary_margin_m`** **from** **props** **/** **`GET …/scenes/{id}`**. **Draw** **12** **edges** **with** **the** **same** **material** **recipe** **as** **§4.7** **model** **boundary** **(**REQ-010** **segment** **style**)**. **Skip** **when** **no** **lights** **(**`n===0`**)**. **When** **`boundary_margin_m`** **or** **light** **positions** **change**, **recompute** **the** **box** **(**REQ-034** **rule** **4**)**.
- **Live updates while a routine runs (REQ-012, REQ-029, REQ-031):** **While** **`/scenes/[id]`** **is** **mounted** **and** **`GET …/routines/runs`** **shows** **`running`**, **poll** **`GET /api/v1/scenes/{id}`** **every** **`≤ 2 s`** **(covers** **Python** **iterations**, **~1** **s** **effects**, **and** **shape** **animation** **ticks** **—** **editor** **tabs** **also** **refetch** **after** **local** **`PATCH`** **per** **§4.13**/**§4.14**)** **and** **merge** **`items[].lights`** **into** **`SceneLightsCanvas`**. **Apply** **§3.19** **equivalence** **so** **unchanged** **poll** **payloads** **skip** **redundant** **canvas** **work**. **Active** **runs** **write** **only** **through** **§3.15** **(**Pyodide** **§3.17** **or** **shape** **engine** **§3.17.2**)**; **polling** **merges** **authoritative** **state** **for** **other** **tabs**. **Stop** **polling** **when** **no** **run** **is** **active** **or** **on** **unmount**. **High-frequency** **external** **writers** **SHOULD** **use** **§3.15** **bulk**/**batch** **(**§3.18**)**; **optional** **SSE** **(**§3.18**/**§8.19**)** **reduces** **polling** **when** **implemented**.
...
- **Framing (REQ-016):** **Fit** **camera** **using** **the** **§3.12** **“comfort”** **box** **`[0,0,0]`** **–** **`(Mmax+1)`** **per** **axis** **plus** **marker** **radius** **(**same** **`applyDefaultFraming`** **pattern** **as** **§4.7**,** **scene-space** **`(sx,sy,sz)`** **)** **—** **independent** **of** **REQ-034** **`m`** **unless** **implementor** **explicitly** **unifies** **framing** **with** **the** **padded** **light** **AABB** **(**document** **in** **code** **if** **so**)**. **A** **“Reset camera”** **control** **on** **the** **scene** **canvas** **re-invokes** **that** **same** **fit** **(no** **API** **call**)**.**
...
### 4.12 Routines management UI (**REQ-021**, **REQ-023**, **REQ-033**, **REQ-034**)
...
### 4.13 Python routine editor, API reference below editor, unified run and live viewport (**REQ-022**–**REQ-032**, **REQ-023**, **REQ-034**)
...
### 4.14 Shape animation routine editor and unified run / live viewport (**REQ-033**, **REQ-027**, **REQ-028**, **REQ-002**, **REQ-034**)
...
- **Run** **driver:** **On** **Start**, **`POST …/start`** **then** **begin** **§3.17.2** **tick** **loop** **in** **the** **page** **(**or** **dedicated** **`Worker`)** **;** **on** **Stop** **or** **unmount**, **`POST …/stop`** **and** **cancel** **timers**. **Cooperative** **stop** **when** **`GET …/routines/runs`** **shows** **no** **`running`** **(**e.g.** **stopped** **from** **another** **tab** **—** **optional** **lightweight** **poll** **every** **~1** **s** **while** **local** **loop** **active**)**.
- **Viewport** **sync:** **After** **each** **successful** **`PATCH …/lights/state/batch`** **(**or** **skipped** **tick** **per** **§3.19**)** , **refetch** **`GET /api/v1/scenes/{id}`** **or** **`GET …/lights`** **and** **merge** **into** **`SceneLightsCanvas`** **(**REQ-012**/**REQ-028**)**. **`SceneLightsCanvas`** **MUST** **draw** **the** **REQ-034** **boundary** **using** **`boundary_margin_m`** **from** **the** **same** **`GET …/scenes/{id}`** **payload** **(**or** **equivalent** **merge** **path**)**.
...
- **Scene** **routines** **(REQ-021):** **No** **in-process** **Go** **`time.Ticker`** **for** **routine** **simulation** **(**§3.16**)** **—** **Python** **runs** **in** **the** **browser** **Pyodide** **worker** **(**§3.17**)** **and** **shape** **animation** **in** **the** **browser** **TS** **engine** **(**§3.17.2**)**.
...
flowchart TB
  ...
  G --> DB[(SQLite models lights scenes scene_models routines routine_runs python_source definition_json)]
```
...
### 8.11 Load scene detail and render composite WebGL (**REQ-015**, **REQ-019**, **REQ-012**, **REQ-028**, **REQ-034**)
...
sequenceDiagram
  ...
  R->>R: Draw faint REQ-034 boundary cuboid from tight sx,sy,sz AABB + boundary_margin_m from JSON
  R->>R: Apply same REQ-019 fixed dark-grey viewport as model detail §4.7
  R-->>User: WebGL canvas + add remove placement controls + optional PATCH boundary margin per §4.9
```
...
sequenceDiagram
  ...
  P->>G: POST
  alt success
    G->>S: BEGIN; DELETE routine_runs, routines, scene_models, scenes, lights, models; SeedDefaultSamples; SeedDefaultPythonRoutines; COMMIT
    Note over G,S: routines delete removes shape_animation and python_scene_script rows
    S-->>G: OK
    G-->>P: 200 { ok: true }
    P-->>B: 200
    B->>B: Clear client caches; navigate to /models; show success banner
    B-->>User: Model list shows three samples; routine list shows three default Python samples only
  else failure
    G-->>P: 500 JSON error
    P-->>B: 500
...
### 8.16 Scene routine start, Pyodide loop, and stop (**REQ-021**, **§3.16**, **§3.17**)
...
sequenceDiagram
  ...
  B->>W: Load python_source; loop until stop
  loop Each worker iteration
    W->>P: fetch PATCH/GET §3.15 scene routes
    P->>G: HTTP
    G->>S: Validate and UPDATE lights
    S-->>G: OK
    G-->>P: 200 JSON
    P-->>W: Response
  end
  ...
  G-->>P: 200
  P-->>B: 200
  B->>W: Cooperative stop; terminate if needed
```

**§8.17** **expands** **this** **path** **with** **the** **Next.js** **editor**/**page**, **`PATCH`** **save**, **and** **REQ-030** **(**`scene.random_hex_colour()`** **local** **to** **the** **worker**)**.
...
### 8.21 Scene routine start — Python vs shape animation (**REQ-021**, **§3.16**)
...
sequenceDiagram
  ...
  participant Eng as Shape animation engine §3.17.2
  ...
  alt routine type python_scene_script
    Page->>Py: init worker + python_source
    loop iterations
      Py->>G: fetch PATCH GET §3.15
      G-->>Py: 200 JSON
    end
  else routine type shape_animation
    Page->>Eng: startTickLoop definition_json sceneId runId
    loop each tick
      Eng->>G: fetch PATCH …/lights/state/batch
      G-->>Eng: 200 JSON
    end
  end
  ...
  Page->>Py: stop or terminate
  Page->>Eng: cancel timers
```

### 8.22 Shape animation page — unified viewport and batch tick writes (**REQ-033**, **REQ-027**, **§3.17.2**)

```mermaid
sequenceDiagram
  actor User as User device
  participant Page as Next.js §4.14
  participant Eng as shapeAnimationEngine
  ...
  loop each simulation tick
    Eng->>G: GET dimensions optional
    Eng->>Eng: integrate positions assign lights
    Eng->>G: PATCH …/lights/state/batch
    G-->>Eng: 200
    Page->>G: GET scene or GET lights
    G-->>Page: fresh state
    Page->>C: merge REQ-012 REQ-028
  end
...
| REQ-010 | §1, §4.6, §4.7 (incl. REQ-034 model boundary wire recipe), §8.4–§8.6 |
...
| REQ-015 | §1, §3.1, §3.2, §3.12–§3.13 (incl. `boundary_margin_m` + `PATCH /scenes/{id}`), §4.6, §4.9 (composite three.js + REQ-028 via §4.7 + REQ-034), §7 (DB), §8.10–§8.12 |
...
| REQ-020 | §1, §3.2, §3.12, §3.13, §3.15 (dimensions `margin_m` = `boundary_margin_m` per REQ-034), §8.15 |
...
| REQ-026 | §3.15 (axis mapping for `size` and `max`; `margin_m` tied to scene `m`), §3.17 (`scene.width` / `height` / `depth` / `max_*`), §4.13 |
| REQ-027 | §3.15 (`PATCH …/lights/state/scene` for reset), §4.7, §4.9, §4.13, §4.14 (unified viewport + REQ-034 boundary from scene payload), §8.18, §8.22 (with REQ-028 materials via shared canvas) |
| REQ-028 | §1, §4.7, §4.9, §4.13, §4.14, §6.5, §8.5, §8.7 (boundary is separate LineSegments — REQ-034) |
| REQ-029 | §1, §3.2, §3.10, §3.15, §3.18, §3.19 (observer alignment), §4.3, §4.7, §4.9, §6, §7, §8.19, §9 |
| REQ-030 | §1, §3.17, §3.17.2 (random colour distribution for shape mode), §4.13, §8.17 (local helper note; no HTTP in sequence) |
| REQ-031 | §3.9, §3.10 (batch note), §3.15 (bulk semantics), §3.16 (`routine_runs` persistence), §3.17.2 (optional tick skip), §3.18, §3.19, §4.7, §4.9, §4.13, §4.14, §8.7, §8.8, §8.20 (elide redundant boundary rebuilds when box unchanged) |
...
| REQ-033 | §3.2 (routines API rows), §3.16, §3.17.2 (sim bounds follow `GET …/dimensions` `margin_m` = scene `m`), §4.12, §4.14, §6.2, §8.21, §8.22 |
| REQ-034 | §3.12 (`scenes.boundary_margin_m`), §3.13 (`GET`/`PATCH` scene), §3.15 (`GET …/dimensions` `margin_m`), §3.17.2, §4.7 (model view fixed 0.3 m), §4.9, §4.12–§4.14, §8.11 |

---

**Next step:** Invoke **`@implementor`** **then** **`@verifier`** **to** **persist** **`boundary_margin_m`**, **add** **`PATCH /api/v1/scenes/{id}`**, **align** **`GET …/dimensions`**, **draw** **faint** **boundary** **cuboids** **in** **`ModelLightsCanvas`** **/** **`SceneLightsCanvas`**, **and** **expose** **the** **margin** **control** **on** **scene** **detail** **per** **§3.12–§3.15** **and** **§4.7**/**§4.9**. **Then** **update** **`docs/traceability_matrix.md`**. **REQ-022** **remains** **CodeMirror** **6** **+** **Pyodide** **(**§4.13**)**. **REQ-023** **is** **the** **§4.12** **two-kind** **create** **path** **(**Python** **or** **shape** **animation**)**. **REQ-027** **applies** **to** **both** **§4.13** **and** **§4.14** **unified** **panels** **(**§8.18**, **§8.22**)** **including** **REQ-034** **boundary** **rendering** **from** **`GET …/scenes/{id}`**.
