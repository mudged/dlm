...
- REQ-002, REQ-011, REQ-015, REQ-020, REQ-021 (coexistence with other routine mechanisms), REQ-018 (buttons/icons where applicable), REQ-024 (API reference placement and interaction), REQ-027 (unified run and live viewport)
...
- Out of scope: **Full** **OpenAPI** **HTTP** **catalog** **as** **the** **only** **form** **of** **docs** **unless** **architecture** **collapses** **Python** **to** **thin** **HTTP** **wrappers** **only**; **replacing** **REQ-027**’s **unified** **run**/**viewport** **region** **(**which** **follows** **the** **reference** **in** **page** **order** **per** **architecture**)**.
...
- REQ-002, REQ-018, REQ-022, REQ-027 (page order relative to unified run viewport per architecture)
