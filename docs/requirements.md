...
- REQ-002, REQ-006, REQ-009, REQ-011, REQ-014, REQ-015, REQ-021, REQ-022, REQ-032
...
- In scope: **Routine definitions** are **Python** **routines** only (**REQ-022**): persisted with **name**, **description**, and a **routine** **kind** that is **uniformly** **Python** **(architecture** **may** **fix** **one** **machine-readable** **type** **value** **or** **omit** **redundant** **type** **UI** **per** **REQ-023**)**. User or API flows to **create**, **list**, and **delete** definitions. **Start** a routine **against a chosen scene** and **stop** a running instance **without** deleting the definition. While **running**, **Python** **execution** (**REQ-022**) MUST apply state changes **only** through **scene-level** operations consistent with **REQ-020** (and **REQ-011** field semantics), using **scene-space** geometry for any **region-scoped** updates; canonical stored model coordinates MUST NOT be rewritten (**REQ-015**). **Effects** **authored** **in** **Python** MAY restrict which lights are affected using **cuboid** or **sphere** volumes in **scene space** (**REQ-020** shapes and composition rules). **Stopping** ends automation; **per-light state** remains whatever was last successfully written (**REQ-011**). **Default** **sample** **behaviors** **(**including** **the** **former** **built-in** **“random** **colour** **cycle** **—** **all** **scene** **lights”** **effect**)** **are** **delivered** **as** **seeded** **Python** **definitions** **per** **REQ-032**, **not** **as** **separate** **non-Python** **routine** **types**.
- Out of scope: **Non-Python** **routine** **types** **(**dedicated** **engine** **built-ins** **outside** **REQ-022**)**; **editing** **routine** **definitions** **after** **create** **(**unless** **implemented** **via** **the** **Python** **editor** **per** **REQ-022**)**; **physical** **hardware** **protocols**; **new** **volumetric** **shapes** **beyond** **REQ-020**; **routines** **that** **move** **or** **reorder** **lights** **in** **REQ-005** **space**; **authentication** **policy**.

**Business rules**

1. The product MUST support **creating** a routine definition with **name**, **description**, and **routine** **kind** **consistent** **with** **Python-only** **routines** (**REQ-022**); **listing** all routine definitions; and **deleting** a definition. **Name** is **required** at create time; **description** MAY be empty if architecture allows, but the field MUST exist.
...
3. While a routine **run** is **active**, any change to **on/off**, **hex colour**, or **brightness** for lights in that scene performed **by** **the** **routine** MUST be effected **through** **the** **Python** **scene** **binding** **and** **underlying** **scene** **API** **surface** **from** **REQ-020**/**REQ-022**, not by **bypassing** **that** **surface** **for** **scene-contextual** **automation**. (Direct per-light model APIs **REQ-011** remain valid for **manual** user or integrator actions outside this requirement.)
...
- REQ-002 (when UI surfaces routines), REQ-011, REQ-015, REQ-020, REQ-022
...
- Out of scope: **Non-Python** **routine** **engines** **(**REQ-021** **is** **Python-only** **with** **REQ-032** **defaults**)**; **arbitrary** **pip** **packages** **unless** **explicitly** **added** **later**; **editing** **model** **CSV** **or** **scene** **geometry** **from** **Python**; **authentication** **policy**; **remote** **IDE** **integration**.
...
### REQ-023 — Create routine: Python-only (no non-Python routine kinds)

| Field | Value |
|-------|-------|
| **ID** | REQ-023 |
| **Title** | Create routine: Python-only (no non-Python routine kinds) |
| **Priority** | Must |
| **Actor(s)** | End user |

**User story**

As a user **creating** a **new** **routine**, I want **one** **clear** **path** **that** **always** **creates** **a** **Python** **routine**, so that **I** **am** **not** **asked** **to** **pick** **among** **obsolete** **non-Python** **built-in** **kinds** **and** **I** **land** **directly** **in** **the** **Python** **authoring** **experience**.

**Scope**

- In scope: **REQ-021** **defines** **only** **Python** **routine** **definitions**. The **user-facing** **flow** **to** **start** **creating** a **new** **routine** **MUST** **proceed** **to** **the** **Python** **authoring** **experience** **(**REQ-022**)** **without** **offering** **a** **separate** **non-Python** **routine** **kind** **(**e.g.** **no** **dropdown** **entry** **for** **a** **dedicated** **engine** **“test** **routine”** **type** **that** **is** **not** **Python** **code**)**. **Architecture** **MAY** **omit** **a** **routine** **type** **selector** **entirely** **when** **only** **one** **kind** **exists**, **or** **MAY** **show** **a** **single** **fixed** **choice** **(**e.g.** **“Python”**)** **if** **that** **aids** **discoverability**, **provided** **rule** **2** **holds**. The **product** **MUST** **not** **require** **a** **separate** **primary** **“create** **Python** **routine”** **button** **that** **duplicates** **the** **only** **create** **path** **(**one** **obvious** **“new** **routine”** **or** **equivalent** **is** **sufficient**)**.
- Out of scope: **Changing** **REQ-021**/**022** **persistence** **or** **API** **contracts** **except** **where** **the** **UI** **must** **bind** **to** **them**; **editing** **existing** **definitions**.

**Business rules**

1. **New** **routine** **creation** **MUST** **not** **present** **any** **creatable** **non-Python** **routine** **kind** **(**all** **new** **definitions** **are** **Python** **per** **REQ-021** **and** **REQ-022**)**.
2. **If** **the** **UI** **still** **shows** **a** **type** **control**, **its** **options** **MUST** **not** **imply** **multiple** **distinct** **executable** **engines** **beyond** **Python** **(**at** **most** **one** **effective** **choice** **or** **a** **read-only** **label**)**.
3. **The** **UI** **MUST** **not** **present** **a** **standalone** **primary** **action** **whose** **sole** **purpose** **is** **to** **start** **creating** **only** **a** **Python** **routine** **when** **that** **is** **already** **the** **only** **outcome** **of** **the** **main** **“new** **routine”** **flow** **(**avoid** **redundant** **parallel** **entry** **points**)**.
4. **REQ-002** **applies**: **any** **create** **control** **MUST** **be** **operable** **on** **mobile**, **tablet**, **and** **desktop** **without** **hover-only** **essential** **steps**.

**Responsive / UX notes** *(when UI is involved)*

- Mobile: **Create** **action** **touch-friendly**; **no** **confusing** **multi-kind** **picker** **with** **one** **real** **option**.
- Tablet: **Same** **as** **mobile**.
...
- **Whether** **to** **remove** **legacy** **type** **dropdown** **UI** **entirely** **vs** **keep** **a** **single** **labeled** **Python** **row** **for** **clarity**.
