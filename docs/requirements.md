...
As an end user, I want to **define** **and** **edit** **shape** **animation** **routines** **with** **a** **name** **and** **description** **like** **Python** **routines**, **configure** **animated** **sphere** **or** **cuboid** **shapes** **in** **scene** **space**, **preview** **them** **with** **run** **on** **scene** **in** **the** **same** **unified** **viewport** **as** **Python** **authoring** **(**REQ-027**)** , **and** **have** **every** **light** **inside** **each** **shape** **show** **that** **shape’s** **colour** **while** **other** **lights** **show** **the** **background** **or** **turn** **off**, **so** **that** **I** **can** **create** **moving** **colour** **regions** **without** **writing** **code**.
...
4. **Shape** **colour:** **Either** **fixed** **REQ-011**-valid **hex** **or** **“random”** **so** **that** **each** **time** **the** **shape** **colour** **is** **chosen** **(**e.g.** **new** **loop** **cycle** **or** **respawn** **—** **architecture** **ties** **to** **rule** **10**)** **it** **is** **a** **uniform** **random** **REQ-011**-valid **colour** **(**same** **distribution** **intent** **as** **REQ-030**)**. **Lights** **inside** **the** **closed** **shape** **volume** **(**REQ-020** **inclusion** **semantics** **for** **sphere**/**cuboid**)** **MUST** **be** **on** **with** **that** **shape’s** **colour** **and** **brightness** **100** **percent** **unless** **architecture** **documents** **a** **single** **optional** **per-shape** **brightness** **control** **(**default** **100** **if** **omitted**)**.
...
6. **Motion:** **Each** **shape** **moves** **in** **a** **straight** **line** **in** **scene** **space** **with** **constant** **velocity** **components** **(**vx**, **vy**, **vz** **in** **SI** **units** **per** **second** **or** **equivalent** **documented** **form**)** **including** **zero** **on** **any** **axis** **;** **user** **configures** **signed** **direction** **per** **axis** **(**positive** **or** **negative** **along** **scene** **x**, **y**, **z**)**. **Architecture** **documents** **simulation** **timestep** **and** **relation** **to** **REQ-029**.
...
11. **Concurrency** **and** **validation:** **Invalid** **numeric** **ranges** **(**e.g.** **min** **>** **max** **size**)** , **empty** **shape** **list**, **more** **than** **20** **shapes**, **or** **non-finite** **parameters** **MUST** **be** **rejected** **at** **save** **or** **run** **with** **clear** **errors**. **Interaction** **with** **other** **active** **runs** **on** **the** **same** **scene** **follows** **the** **same** **policy** **as** **REQ-021** **open** **questions** **once** **resolved** **in** **architecture**.
12. **`docs/architecture.md`** **MUST** **describe** **persistence** **shape** **for** **definitions**, **simulation** **tick**, **wrap**/**deflect** **details**, **overlap** **precedence**, **and** **how** **REQ-027** **applies** **to** **this** **kind** **(**no** **Python** **editor** **or** **REQ-024** **on** **this** **surface** **unless** **optional** **cross-links** **only**)**.
...
- **Whether** **per-shape** **brightness** **(**below** **100** **%**)** **is** **required** **or** **fixed** **at** **100** **%** **for** **lights** **inside** **shapes**.
