...
Feature: Full-stack composition (Go, Next.js, Tailwind)
  ...
  Scenario: Requirements mandate Go backend and Next.js with Tailwind
    ...
    Given docs/requirements/requirements.md exists
...
Feature: Raspberry Pi 4 Model B deployment
  ...
  Scenario: Requirements bind architecture to Pi-oriented documentation
    ...
    Then they require docs/design/architecture.md to describe Go and Next.js on Pi 4 Model B after the architect pass
...
Feature: Single executable packaging without Docker
  ...
  Scenario: REQ-004 requires architecture reconciliation with Pi and UI requirements
    ...
    Then they require docs/design/architecture.md to be updated for a consistent single-binary model with REQ-003 and REQ-001
...
Feature: Wire light model definition
  ...
  Scenario: REQ-005 defines chain adjacency at most two neighbors
    Parent requirement: REQ-005
    Given docs/requirements/requirements.md defines REQ-005
...
Feature: Model management in the application
  ...
  Scenario: REQ-006 blocks model delete when model is used in scenes and explains why
    Parent requirement: REQ-006
    Given docs/requirements/requirements.md defines REQ-006 and REQ-015
...
Feature: Single command build and run (REQ-008)
  ...
  Scenario: README documents the one-shot build-and-run command
    ...
    Given docs/requirements/requirements.md defines REQ-008
...
Feature: Default geometric sample models (REQ-009)
  ...
  Scenario: Each sample has between 500 and 1000 lights
    Parent requirement: REQ-009
    Given docs/requirements/requirements.md defines REQ-005 and REQ-009
  ...
  Scenario: Sample lights lie on or near the outside surface not inside
    Parent requirement: REQ-009
    Given docs/requirements/requirements.md defines REQ-009
...
Feature: Three.js model view (REQ-010)
  ...
  Scenario: REQ-010 requires 2 cm spheres with white default or REQ-012 state appearance
    Parent requirement: REQ-010
    Given docs/requirements/requirements.md defines REQ-010 and REQ-012
  ...
  Scenario: REQ-010 requires D0D0D0 light grey 85 percent transparent segments between consecutive ids
    Parent requirement: REQ-010
    Given docs/requirements/requirements.md defines REQ-005 and REQ-010
...
Feature: Per-light state REST API (REQ-011)
  ...
  Scenario: REQ-011 requires hex colour validation and brightness percent range
    Parent requirement: REQ-011
    Given docs/requirements/requirements.md defines REQ-011
  ...
  Scenario: REQ-011 requires authoritative in-memory state after successful writes
    Parent requirement: REQ-011
    Given docs/requirements/requirements.md defines REQ-011 and REQ-039
    When the REQ-011 business rules are read
  ...
  Scenario: REQ-011 binds default state to REQ-014 and cross-surface consistency
    Parent requirement: REQ-011
    Given docs/requirements/requirements.md defines REQ-011 and REQ-014
...
Feature: Visualization reflects light state (REQ-012)
  ...
  Scenario: On lights appear filled with hex colour and brightness
    ...
    Given docs/requirements/requirements.md defines REQ-012
  ...
  Scenario: REQ-012 applies defaults for lights without established authoritative state
    Parent requirement: REQ-012
    Given docs/requirements/requirements.md defines REQ-011 REQ-014 REQ-012 and REQ-039
...
Feature: Model view light list pagination and bulk settings (REQ-013)
  ...
  Scenario: REQ-013 requires paginated light list and page size control
    ...
    Given docs/requirements/requirements.md defines REQ-013
  ...
  Scenario: REQ-013 requires multi-select and bulk apply of REQ-011 fields
    Parent requirement: REQ-013
    Given docs/requirements/requirements.md defines REQ-011 and REQ-013
  ...
  Scenario: REQ-013 requires batch HTTP API when applying to two or more selected lights at once
    ...
    Then when two or more lights are selected and the user applies settings in one bulk action the client must use the documented model-scoped batch light-state API from docs/design/architecture.md
  ...
  Scenario: REQ-013 binds bulk updates to visualization timeliness
    Parent requirement: REQ-013
    Given docs/requirements/requirements.md defines REQ-012 and REQ-013
  ...
  Scenario: REQ-013 ties pagination and multi-select to responsive UX
    Parent requirement: REQ-013
    Given docs/requirements/requirements.md defines REQ-002 and REQ-013
...
Feature: Default light state and model reset (REQ-014)
  ...
  Scenario: REQ-014 mandates initial off state with 100 percent white
    ...
    Given docs/requirements/requirements.md defines REQ-014
  ...
  Scenario: REQ-014 requires a reset control on the model view
    Parent requirement: REQ-014
    Given docs/requirements/requirements.md defines REQ-006 and REQ-014
  ...
  Scenario: REQ-014 binds reset to authoritative state and visualization timeliness
    Parent requirement: REQ-014
    Given docs/requirements/requirements.md defines REQ-011 REQ-012 REQ-013 REQ-014 and REQ-039
  ...
  Scenario: REQ-014 requires non-hover-only reset on all device classes
    Parent requirement: REQ-014
    Given docs/requirements/requirements.md defines REQ-002 and REQ-014
...
Feature: Scenes composite 3D space and management (REQ-015)
  ...
  Scenario: REQ-015 requires create with one or more models plus list delete and open
    ...
    Given docs/requirements/requirements.md defines REQ-015
  ...
  Scenario: REQ-015 keeps stored model coordinates separate from derived scene coordinates
    Parent requirement: REQ-015
    Given docs/requirements/requirements.md defines REQ-005 REQ-006 and REQ-015
  ...
  Scenario: REQ-015 requires three.js scene view analogous to model view
    Parent requirement: REQ-015
    Given docs/requirements/requirements.md defines REQ-010 REQ-012 and REQ-015
...
Feature: Camera reset for 3D views (REQ-016)
  ...
  Scenario: REQ-016 requires camera reset on model and scene three.js views
    ...
    Given docs/requirements/requirements.md defines REQ-016
  ...
  Scenario: REQ-016 binds camera reset to responsive non-hover-only use
    Parent requirement: REQ-016
    Given docs/requirements/requirements.md defines REQ-002 and REQ-016
...
Feature: Options factory reset with confirmation (REQ-017)
  ...
  Scenario: REQ-017 requires an Options section with factory reset
    ...
    Given docs/requirements/requirements.md defines REQ-017
  ...
  Scenario: REQ-017 requires prompt and warning before any destructive factory reset
    Parent requirement: REQ-017
    Given docs/requirements/requirements.md defines REQ-017 REQ-033 and REQ-032
  ...
  Scenario: REQ-017 requires post-reset state to match fresh samples
    Parent requirement: REQ-017
    Given docs/requirements/requirements.md defines REQ-009 REQ-011 REQ-014 REQ-017 REQ-021 REQ-022 REQ-033 and REQ-032
  ...
  Scenario: REQ-017 factory reset flow is usable without hover-only steps
    Parent requirement: REQ-017
    Given docs/requirements/requirements.md defines REQ-002 and REQ-017
...
Feature: Application shell themes navigation branding and Font Awesome (REQ-018)
  ...
  Scenario: REQ-018 mandates light and dark themes with specified surfaces
    ...
    Given docs/requirements/requirements.md defines REQ-018
  ...
  Scenario: REQ-018 requires collapsible left navigation toggled by a burger control
    Parent requirement: REQ-018
    Given docs/requirements/requirements.md defines REQ-002 and REQ-018
...
Feature: Three.js fixed dark-grey viewport (REQ-019)
  ...
  Scenario: REQ-019 requires dark-grey three.js backdrop for model and scene in both shell themes
    ...
    Given docs/requirements/requirements.md defines REQ-010 REQ-015 REQ-018 and REQ-019
  ...
  Scenario: REQ-019 keeps three.js viewport responsive per REQ-002
    Parent requirement: REQ-019
    Given docs/requirements/requirements.md defines REQ-002 and REQ-019
...
Feature: Scene spatial API dimensions filters and bulk updates (REQ-020)
  ...
  Scenario: REQ-020 exposes scene dimensions
    ...
    Given docs/requirements/requirements.md defines REQ-020
  ...
  Scenario: REQ-020 returns all scene lights in scene coordinates
    Parent requirement: REQ-020
    Given docs/requirements/requirements.md defines REQ-005 REQ-015 and REQ-020
  ...
  Scenario: REQ-020 supports cuboid-based bulk light updates in scene space
    Parent requirement: REQ-020
    Given docs/requirements/requirements.md defines REQ-011 and REQ-020
...
Feature: Scene routines Python definitions run stop and scene API (REQ-021)
  ...
  Scenario: REQ-021 requires routine definitions with name description and Python or shape animation kind plus list and delete
    ...
    Given docs/requirements/requirements.md defines REQ-021 REQ-022 and REQ-033
  ...
  Scenario: REQ-021 requires starting and stopping a routine against a scene
    Parent requirement: REQ-021
    Given docs/requirements/requirements.md defines REQ-021
  ...
  Scenario: REQ-021 binds running automation to scene API for light state changes
    Parent requirement: REQ-021
    Given docs/requirements/requirements.md defines REQ-011 REQ-020 REQ-021 REQ-022 and REQ-033
  ...
  Scenario: REQ-021 forbids browser-hosted production routine execution
    Parent requirement: REQ-021
    Given docs/requirements/requirements.md defines REQ-021 REQ-022 REQ-033 and REQ-038
    ...
    And routine automation must run entirely within the Go service process as documented in docs/design/architecture.md

  Scenario: REQ-021 coordinates with device requirements for physical output
    Parent requirement: REQ-021
    Given docs/requirements/requirements.md defines REQ-021 REQ-035 REQ-036 REQ-038 and REQ-039
  ...
  Scenario: REQ-021 allows volumetric targeting in scene space when scripts use regions
    Parent requirement: REQ-021
    Given docs/requirements/requirements.md defines REQ-020 and REQ-021
  ...
  Scenario: REQ-032 default random colour cycle routine matches former all-lights test routine behavior
    ...
    Given docs/requirements/requirements.md defines REQ-011 REQ-015 REQ-020 REQ-021 REQ-022 and REQ-032
    ...
    And the approximate one-second cadence must be documented in docs/design/architecture.md

  Scenario: REQ-032 stopping the random colour cycle routine ends automation without implicit reset to defaults
    Parent requirement: REQ-032
    Given docs/requirements/requirements.md defines REQ-011 REQ-014 REQ-021 REQ-022 and REQ-032
  ...
  Scenario: REQ-021 ties routine UI to responsive non-hover-only use when exposed
    Parent requirement: REQ-021
    Given docs/requirements/requirements.md defines REQ-002 and REQ-021
  ...
  Scenario: REQ-017 factory reset removes routine data per REQ-021 REQ-022 and REQ-033 scope
    Parent requirement: REQ-017
    Given docs/requirements/requirements.md defines REQ-017 REQ-021 REQ-022 REQ-033 and REQ-032
...
Feature: Routine runs synchronize visualization and physical lights; server-side headless execution (REQ-038)
  ...
  Scenario: REQ-038 browser is observation-only for routine-driven state
    ...
    Given docs/requirements/requirements.md defines REQ-038 REQ-021 REQ-041 and REQ-039
...
Feature: Python scene routines editor API docs and execution (REQ-022)
  ...
  Scenario: REQ-022 requires in-browser Python editor with highlighting checking completion and formatting
    ...
    Given docs/requirements/requirements.md defines REQ-022
  ...
  Scenario: REQ-022 requires documented Python scene library on the same page as the editor
    Parent requirement: REQ-022
    Given docs/requirements/requirements.md defines REQ-022 REQ-020 REQ-024 and REQ-011
  ...
  Scenario: REQ-022 forbids rewriting canonical model coordinates from Python automation
    Parent requirement: REQ-022
    Given docs/requirements/requirements.md defines REQ-005 REQ-015 and REQ-022
  ...
  Scenario: REQ-022 ties editor docs and run controls to responsive non-hover-only use
    Parent requirement: REQ-022
    Given docs/requirements/requirements.md defines REQ-002 and REQ-022
...
Feature: Create routine kind choice Python or shape animation (REQ-023)
  ...
  Scenario: REQ-023 requires new routine creation to offer Python or shape animation only
    ...
    Given docs/requirements/requirements.md defines REQ-021 REQ-022 REQ-033 and REQ-023
  ...
  Scenario: REQ-023 limits type control options to the two defined kinds
    Parent requirement: REQ-023
    Given docs/requirements/requirements.md defines REQ-023
  ...
  Scenario: REQ-023 ties create flow controls to responsive non-hover-only use
    Parent requirement: REQ-023
    Given docs/requirements/requirements.md defines REQ-002 and REQ-023
...
Feature: Python routine API reference below editor (REQ-024)
  ...
  Scenario: REQ-024 requires API reference directly below the code editor
    ...
    Given docs/requirements/requirements.md defines REQ-002 REQ-022 and REQ-024
  ...
  Scenario: REQ-024 requires selectable API entries with detail sample usage commented snippets and insert control
    Parent requirement: REQ-024
    Given docs/requirements/requirements.md defines REQ-022 and REQ-024
  ...
  Scenario: REQ-024 catalog documents API items and does not replace REQ-032 default routines
    Parent requirement: REQ-024
    Given docs/requirements/requirements.md defines REQ-024 and REQ-032
...
Feature: Python routine default sphere colour template (REQ-025)
  ...
  Scenario: REQ-025 requires new Python routines to open with sphere-region colour change template
    ...
    Given docs/requirements/requirements.md defines REQ-011 REQ-020 REQ-022 REQ-024 and REQ-025
...
Feature: Python scene binding width depth height (REQ-026)
  ...
  Scenario: REQ-026 requires scene width depth and height on the Python binding
    ...
    Given docs/requirements/requirements.md defines REQ-020 REQ-022 REQ-024 and REQ-026
...
Feature: Routine authoring unified run-in-scene and live viewport (REQ-027)
  ...
  Scenario: REQ-027 requires one unified region for scene target run stop and live three.js viewport on each routine kind
    ...
    Given docs/requirements/requirements.md defines REQ-002 REQ-010 REQ-012 REQ-015 REQ-019 REQ-022 REQ-033 and REQ-027
  ...
  Scenario: REQ-027 requires reset scene lights and reset camera controls
    Parent requirement: REQ-027
    Given docs/requirements/requirements.md defines REQ-011 REQ-014 REQ-016 REQ-018 REQ-021 REQ-027 REQ-039 and REQ-040
  ...
  Scenario: REQ-027 unified region remains usable without hover-only essential steps
    Parent requirement: REQ-027
    Given docs/requirements/requirements.md defines REQ-002 and REQ-027
...
Feature: Three.js emissive glow scaled by brightness (REQ-028)
  ...
  Scenario: REQ-028 requires emissive appearance for on light spheres in three.js views
    ...
    Given docs/requirements/requirements.md defines REQ-010 REQ-012 REQ-015 REQ-027 REQ-039 and REQ-028
  ...
  Scenario: REQ-028 ties glow strength to REQ-011 brightness with strong appearance at 100 percent
    Parent requirement: REQ-028
    Given docs/requirements/requirements.md defines REQ-011 REQ-039 and REQ-028
  ...
  Scenario: REQ-028 requires monotonic glow versus brightness for the same hex colour
    Parent requirement: REQ-028
    Given docs/requirements/requirements.md defines REQ-028
  ...
  Scenario: REQ-028 preserves REQ-012 off appearance without glow like on lights
    Parent requirement: REQ-028
    Given docs/requirements/requirements.md defines REQ-010 REQ-012 and REQ-028
  ...
  Scenario: REQ-028 binds visualization timeliness and architecture documentation
    Parent requirement: REQ-028
    Given docs/requirements/requirements.md defines REQ-003 REQ-011 REQ-012 REQ-039 and REQ-028
...
Feature: High-throughput light updates (REQ-029)
  ...
  Scenario: REQ-029 states scale assumptions for many lights and frequent updates
    ...
    Given docs/requirements/requirements.md defines REQ-005 REQ-011 and REQ-029
  ...
  Scenario: REQ-029 requires architecture to document write path observer path and transport considerations
    Parent requirement: REQ-029
    Given docs/requirements/requirements.md defines REQ-003 REQ-011 REQ-012 REQ-020 and REQ-029
  ...
  Scenario: REQ-029 requires aggregate update paths while preserving REQ-011 per-light operations
    Parent requirement: REQ-029
    Given docs/requirements/requirements.md defines REQ-011 REQ-020 and REQ-029
  ...
  Scenario: REQ-029 ties high-throughput expectations to Pi deployment constraints
    Parent requirement: REQ-029
    Given docs/requirements/requirements.md defines REQ-003 and REQ-029
    When the REQ-029 scope is read
  ...
  Scenario: REQ-029 business rule 5 points shipped web three.js observer path to REQ-041
    Parent requirement: REQ-029
    Given docs/requirements/requirements.md defines REQ-029 and REQ-041
...
Feature: Python scene API random hex colour helper (REQ-030)
  ...
  Scenario: REQ-030 requires a documented random colour helper on the Python scene binding
    ...
    Given docs/requirements/requirements.md defines REQ-022 REQ-011 and REQ-030
  ...
  Scenario: REQ-030 matches uniform 24-bit hex distribution and REQ-011 string shape
    Parent requirement: REQ-030
    Given docs/requirements/requirements.md defines REQ-011 and REQ-030
  ...
  Scenario: REQ-030 requires REQ-024 catalog completion and worker editor alignment
    Parent requirement: REQ-030
    Given docs/requirements/requirements.md defines REQ-022 REQ-024 and REQ-030
...
Feature: Redundant light-state skips (visualization, in-memory authority, device traffic) (REQ-031)
  ...
  Scenario: REQ-031 requires skipping unnecessary visualization work when state is unchanged
    ...
    Given docs/requirements/requirements.md defines REQ-031
  ...
  Scenario: REQ-031 should reduce redundant updates when authoritative state would not change
    Parent requirement: REQ-031
    Given docs/requirements/requirements.md defines REQ-011 REQ-020 REQ-031 and REQ-039
    ...
    And observable API behavior for such no-op cases must be documented in docs/design/architecture.md

  Scenario: REQ-031 aligns device traffic skips with REQ-035 through REQ-038
    Parent requirement: REQ-031
    Given docs/requirements/requirements.md defines REQ-031 REQ-035 REQ-036 REQ-038 and REQ-039
    When the REQ-031 business rules about physical devices are read
    Then docs/design/architecture.md must describe how assigned devices receive only changes not equivalent to last applied on the device or channel
  ...
  Scenario: REQ-031 preserves REQ-012 when state actually changes
    Parent requirement: REQ-031
    Given docs/requirements/requirements.md defines REQ-012 and REQ-031
  ...
  Scenario: REQ-031 requires architecture documentation of equivalence cache and no-op semantics
    Parent requirement: REQ-031
    Given docs/requirements/requirements.md defines REQ-029 and REQ-031
    When docs/design/architecture.md is read after the architect pass
...
Feature: Default seeded Python sample routines (REQ-032)
  ...
  Scenario: REQ-032 seeds three default Python routines on fresh install and factory reset
    Parent requirement: REQ-032
    Given docs/requirements/requirements.md defines REQ-017 REQ-021 REQ-022 and REQ-032
  ...
  Scenario: REQ-032 mandates three novice-oriented routines using public scene API only
    Parent requirement: REQ-032
    Given docs/requirements/requirements.md defines REQ-032
  ...
  Scenario: Growing sphere routine centers fills scene over ten seconds and loops with new random colour
    Parent requirement: REQ-032
    Given docs/requirements/requirements.md defines REQ-011 REQ-020 REQ-022 REQ-026 REQ-030 and REQ-032
  ...
  Scenario: REQ-032 default routines must not rewrite canonical model coordinates
    Parent requirement: REQ-032
    Given docs/requirements/requirements.md defines REQ-005 REQ-015 REQ-020 and REQ-032
  ...
  Scenario: Architecture documents where REQ-032 seed content is defined
    Parent requirement: REQ-032
    Given docs/requirements/requirements.md defines REQ-032 and REQ-025
    When docs/design/architecture.md is read after the architect pass
...
Feature: Shape animation routines declarative authoring and run (REQ-033)
  ...
  Scenario: REQ-033 defines second routine kind with name description and parameters
    ...
    Given docs/requirements/requirements.md defines REQ-033
  ...
  Scenario: REQ-033 add and edit includes unified run on scene viewport per REQ-027
    Parent requirement: REQ-033
    Given docs/requirements/requirements.md defines REQ-027 and REQ-033
  ...
  Scenario: REQ-033 constrains shapes count type size colour brightness speed position motion and edge behavior
    Parent requirement: REQ-033
    Given docs/requirements/requirements.md defines REQ-033 REQ-020 and REQ-026
  ...
  Scenario: REQ-033 assigns lights inside shapes to shape colour brightness and others to background or off
    Parent requirement: REQ-033
    Given docs/requirements/requirements.md defines REQ-011 REQ-033 and REQ-020
  ...
  Scenario: REQ-033 preserves canonical model coordinates and uses scene API semantics
    Parent requirement: REQ-033
    Given docs/requirements/requirements.md defines REQ-005 REQ-015 REQ-020 REQ-021 and REQ-033
  ...
  Scenario: REQ-033 authoring remains responsive without hover-only essential steps
    Parent requirement: REQ-033
    Given docs/requirements/requirements.md defines REQ-002 and REQ-033
...
Feature: Faint scene boundary cuboid in three.js views (REQ-034)
  ...
  Scenario: REQ-034 defines axis-aligned boundary from light extremes plus symmetric margin
    Parent requirement: REQ-034
    Given docs/requirements/requirements.md defines REQ-034 REQ-010 and REQ-015
  ...
  Scenario: REQ-015 stores scene boundary margin m defaulting to 30 cm and allows edit
    Parent requirement: REQ-015
    Given docs/requirements/requirements.md defines REQ-015 and REQ-034
  ...
  Scenario: REQ-034 applies to model view and scene view including embedded scene canvases
    Parent requirement: REQ-034
    Given docs/requirements/requirements.md defines REQ-034 REQ-010 REQ-015 REQ-027 and REQ-033
  ...
  Scenario: REQ-034 visual prominence matches faint inter-light wire guidance
    Parent requirement: REQ-034
    Given docs/requirements/requirements.md defines REQ-010 REQ-019 and REQ-034
  ...
  Scenario: REQ-034 boundary edges use the same colour opacity and line thickness policy as REQ-010 wire segments
    Parent requirement: REQ-034
    Given docs/requirements/requirements.md defines REQ-010 and REQ-034
  ...
  Scenario: REQ-010 and REQ-015 reference the boundary cuboid requirement
    Parent requirement: REQ-034
    Given docs/requirements/requirements.md defines REQ-010 REQ-015 and REQ-034
...
Feature: Physical devices WLED first and extensibility (REQ-035)
  ...
  Scenario: REQ-035 defines device and mandates WLED as first type
    ...
    Given docs/requirements/requirements.md defines REQ-035
  ...
  Scenario: REQ-035 excludes durable storage of per-light output state
    Parent requirement: REQ-035
    Given docs/requirements/requirements.md defines REQ-035 and REQ-039
  ...
  Scenario: REQ-035 mandates manual device registration for MVP
    Parent requirement: REQ-035
    Given docs/requirements/requirements.md defines REQ-035 and REQ-037
  ...
  Scenario: REQ-035 rejects device base_url values that are not http or https with a host
    Parent requirement: REQ-035
    Given docs/requirements/requirements.md defines REQ-035 business rule 6 for base_url validation
...
Feature: Device model one-to-one assignment (REQ-036)
  ...
  Scenario: REQ-036 requires exclusive at-most-one assignment each side
    ...
    Given docs/requirements/requirements.md defines REQ-036
  ...
  Scenario: REQ-036 requires assign and unassign via Devices management
    Parent requirement: REQ-036
    Given docs/requirements/requirements.md defines REQ-036 and REQ-037
    When the REQ-036 business rules are read
...
Feature: Device management UI (REQ-037)
  ...
  Scenario: REQ-037 requires a Devices section and core flows
    ...
    Given docs/requirements/requirements.md defines REQ-002 REQ-018 REQ-035 REQ-037
  ...
  Scenario: REQ-037 essential actions meet responsive baseline
    Parent requirement: REQ-037
    Given docs/requirements/requirements.md defines REQ-002 and REQ-037
  ...
  Scenario: REQ-037 removing a device clears its model assignment
    Parent requirement: REQ-037
    Given docs/requirements/requirements.md defines REQ-037 REQ-035 and REQ-036
...
Feature: Routines sync physical lights and run on server (REQ-038)
  ...
  Scenario: REQ-038 requires backend routine execution independent of browser
    Parent requirement: REQ-038
    Given docs/requirements/requirements.md defines REQ-021 REQ-038 and REQ-039
  ...
  Scenario: REQ-038 requires physical sync for models with assigned devices
    Parent requirement: REQ-038
    Given docs/requirements/requirements.md defines REQ-015 REQ-021 REQ-035 REQ-036 REQ-038 and REQ-039
  ...
  Scenario: REQ-038 maps device to model local indices not scene placement
    Parent requirement: REQ-038
    Given docs/requirements/requirements.md defines REQ-015 and REQ-038
  ...
  Scenario: REQ-038 headless control uses the same documented API as the UI
    Parent requirement: REQ-038
    Given docs/requirements/requirements.md defines REQ-038
...
Feature: In-memory light authority and sync (REQ-039)
  ...
  Scenario: REQ-039 defines startup and assignment synchronization
    Parent requirement: REQ-039
    Given docs/requirements/requirements.md defines REQ-014 REQ-035 REQ-036 and REQ-039
  ...
  Scenario: REQ-039 states product priority headless over device UI polish
    Parent requirement: REQ-039
    Given docs/requirements/requirements.md defines REQ-037 REQ-038 and REQ-039
  ...
  Scenario: REQ-039 requires architecture to document startup and unassign policies
    Parent requirement: REQ-039
    Given docs/requirements/requirements.md defines REQ-039
    When the REQ-039 business rules are read
    Then docs/design/architecture.md must document one consistent policy when startup sync observes device state that differs from REQ-014 defaults
    And docs/design/architecture.md must document physical output behavior when a device is unassigned from a model
...
Feature: Routine stop within two seconds (REQ-040)
  ...
  Scenario: REQ-040 mandates stop completes within two SI seconds for active runs
    ...
    Given docs/requirements/requirements.md defines REQ-040 REQ-021 REQ-038 and REQ-039
  ...
  Scenario: REQ-040 requires architecture to document Python and shape paths within the two second budget
    Parent requirement: REQ-040
    Given docs/requirements/requirements.md defines REQ-040 REQ-022 and REQ-033
    When REQ-040 business rule 2 is read
    Then docs/design/architecture.md must describe how the Python subprocess and shape animation supervisor meet the two second stop bound
...
Feature: Server-push visualization with incremental apply (REQ-041)
  ...
  Scenario: REQ-041 requires push as primary path for live three.js viewports after initial load
    ...
    Given docs/requirements/requirements.md defines REQ-041 REQ-010 REQ-015 REQ-027 REQ-029 and REQ-039
  ...
  Scenario: REQ-041 requires delta payloads and incremental three.js apply for partial light changes
    Parent requirement: REQ-041
    Given docs/requirements/requirements.md defines REQ-041 REQ-010 REQ-012 REQ-028 and REQ-031
  ...
  Scenario: REQ-041 requires architecture to document transport schema reconnect and Pi plausibility
    Parent requirement: REQ-041
    Given docs/requirements/requirements.md defines REQ-041 REQ-003 REQ-029 and REQ-031
    When REQ-041 business rules 4 and 5 are read
    Then docs/design/architecture.md must name the chosen push transport URL or subscription pattern delta message schema and reconnect full resync behavior
  ...
  Scenario: REQ-041 requires fan-out lookup failures to be logged at WARN with the affected scope
    Parent requirement: REQ-041
    Given docs/requirements/requirements.md defines REQ-041 business rule 6 for observability of fan-out failures
...
Feature: Routine run visibility and visualization resync (REQ-042)
  ...
  Scenario: REQ-042 requires server-backed detection of an active routine on a scene
    ...
    Given docs/requirements/requirements.md defines REQ-021 REQ-027 and REQ-042
  ...
  Scenario: REQ-042 requires live visualization to track authoritative light state
    Parent requirement: REQ-042
    Given docs/requirements/requirements.md defines REQ-012 REQ-039 REQ-041 and REQ-042
  ...
  Scenario: REQ-042 requires resynchronization after navigating away and back while a run remains active
    Parent requirement: REQ-042
    Given docs/requirements/requirements.md defines REQ-042 REQ-021 and REQ-041
  ...
  Scenario: REQ-042 requires consistent UI when start conflicts with an already active run
    Parent requirement: REQ-042
    Given docs/requirements/requirements.md defines REQ-021 and REQ-042
...
Feature: Cross-platform release binaries (REQ-043)
  ...
  Scenario: REQ-043 mandates windows amd64 linux amd64 and linux arm64 targets
    ...
    Given docs/requirements/requirements.md defines REQ-043
  ...
  Scenario: REQ-043 ties Pi deployment to linux arm64 artifact
    Parent requirement: REQ-043
    Given docs/requirements/requirements.md defines REQ-003 and REQ-043
...
Feature: GitHub Actions CI and release (REQ-044)
  ...
  Scenario: REQ-044 requires PR CI build and test gate
    ...
    Given docs/requirements/requirements.md defines REQ-044
  ...
  Scenario: REQ-044 requires tagged release with per-platform binaries
    Parent requirement: REQ-044
    Given docs/requirements/requirements.md defines REQ-043 and REQ-044
...
Feature: Runtime prerequisites on deployment host (REQ-045)
  ...
  Scenario: REQ-045 allows running without Node or Go on the deployment machine
    ...
    Given docs/requirements/requirements.md defines REQ-045
  ...
  Scenario: REQ-045 names Python as the exception for user routines
    Parent requirement: REQ-045
    Given docs/requirements/requirements.md defines REQ-021 REQ-022 and REQ-045
...
Feature: README operator download Pi service and updates (REQ-046)
  ...
  Scenario: README documents release download and Pi artifact choice
    ...
    Given docs/requirements/requirements.md defines REQ-046
...
Feature: Camera-based 3D reconstruction from multiple feeds (REQ-048)
  ...
  Scenario: Reconstruction needs no separate Python install
    Parent requirement: REQ-048
    Given docs/requirements/requirements.md defines REQ-048 REQ-045 and REQ-004
...
**Related documents:** These scenarios trace back to the requirements in [`requirements.md`](requirements.md) and are realized by the design in [`../design/architecture.md`](../design/architecture.md). Follow the Superpowers workflow (see the repository [`AGENTS.md`](../../AGENTS.md)) when turning them into code.
