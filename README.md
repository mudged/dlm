...
Scripts, optional environment variables, developing with two terminals (live-reload UI + API), building for a Raspberry Pi, API performance tips, and troubleshooting live updates are in **[docs/advanced-setup.md](docs/advanced-setup.md)**.
